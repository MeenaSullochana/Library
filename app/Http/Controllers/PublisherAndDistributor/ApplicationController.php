...
class ApplicationController extends Controller
{
    ...
    public function applyadd(Request $req){
        ...
        public function applicationlist(){
           ...
           return view('publisher_and_distributor.fair_application_list')->with('data',$data);   
        }
        ...
        public function applicationview($id){
           ...
           $events->record = $event;
        //   return   $events;
          return redirect('publisher_and_distributor/applyview')->with('events',$events);   
 
     }
        public function pubdistapplication($id){
           $events=events::where('id', '=', $id)->first();
           $publisher=auth('publisher_distributor')->user()->first();
           $events->publisherrecord = $publisher;
        //    return   $events;
         return redirect('publisher_and_distributor/fairmanage')->with('events',$events);   
    ...
    //  return $events;
        return view('publisher_and_distributor.fair_application_apply')->with('events',$events);   
 }
