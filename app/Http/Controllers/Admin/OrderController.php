...
//   return $datas;
     return view('admin.dispatch_overview')->with('datas',$datas); 
...
public function dispatch_library_over_magazine_list(Request $request, $id)
{
    ...
    $orderidArray = explode(',', $orderid);
      ...
      return redirect('admin/dispatch_library');    
  }
  ...
  public function dispatch_magazine_view($id,$orderid){
    ...
    return redirect('admin/dispatch-magazine-view');    
 ...
 public function order_library_item_list($id){
   ...
   return redirect('admin/order_library_item_list');   
   }
