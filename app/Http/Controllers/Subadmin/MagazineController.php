...
public function list(){
    try{
      ...
      return view('sub_admin.magazine_list',compact('magazines'));
    }catch(\Throwable $e){
...
public function magazine_orderview($id){
  ...
  $datas=[];
   ...
   $Ordermagazine->magazineProduct = $datas;
    ...
    return redirect('sub_admin/magazine-order-view');    
  ...
  public function magazine_invoiceview($id){
    ...
    return redirect('sub_admin/magazine-invoice-view');    
  ...
  public function magazine_view($id){
    ...
    return redirect('sub_admin/magazineview');    
  ...
  public function magazine_order_list(Request $request){
    ...
    return view('sub_admin/magazine_order_list', compact('datas','totalAmount'));
  ...
  public function procurement_sampleperiodicalpending(){
    ...
    return view('sub_admin.procurement_sampleperiodicalpending')->with('data',$data); 
}
...
public function procurement_sampleperiodicalcomplete(){
  ...
  return view('sub_admin.procurement_sampleperiodicalcomplete')->with('data',$data); 
}
