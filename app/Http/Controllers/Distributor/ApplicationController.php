...
class ApplicationController extends Controller
{
    ...
    public function applyadd(Request $req){
        ...
        // return $data;
           return view('distributor.fair_application_list')->with('data',$data);   
        }
        ...
        public function applicationview($id){
            ...
            $events->record = $event;
            // return   $events;
          return redirect('distributor/applyview')->with('events',$events);   
    ...
    //  return $events;
        return view('distributor.fair_application_apply')->with('events',$events);   
 }
