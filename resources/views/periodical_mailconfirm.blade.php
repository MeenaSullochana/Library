                ...
                <div class="card mt-5">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="modal-bottom-logo"><img class="text-center w-100"
                                    src="assets/img/icon/border-top.png" alt="" title=""></div>
                            <div class="container">
                                <ul class="nav nav-pills mb-4 light justify-content-center">
                                    <li class=" nav-item">
                                        <a href="#navpills-1" class="nav-link active" data-bs-toggle="tab"
                                            aria-expanded="false"><i
                                                class="fa fa-user p-2 text-success"></i>Publisher</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#navpills-2" class="nav-link" data-bs-toggle="tab"
                                            aria-expanded="false"><i
                                                class="fa fa-user-circle p-2 text-success"></i>Distributor</a>
                                    </li>
                                    <!-- <li class="nav-item">
                                        <a href="#navpills-3" class="nav-link" data-bs-toggle="tab"
                                            aria-expanded="true"><i class="fa fa-users p-2 text-success"></i>Publisher
                                            Cum Distributor</a>
                                    </li> -->
                                </ul>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="overflowTest ms-3">
                                                    @php
                                                    $rev = DB::table('mailconfirm_title')->where('userType', '=',
                                                    'publisher')->first();
                                                    ...
                                                    <h6 class="text-danger">
                                                        <b>{{$rev ? $rev->hidelineTitle : 'Default Title'}}</b></h6>
                                    ...
                                    <div class="position-relative">
                                        <div class="card p-2 text-center">
                                            ...
                                            <div> <span>A code has been sent to</span> <small
                                                    id="emailPlaceholder">{{$data->email}}</small> </div>
                                            <h1>Welcome Back!</h1>
                                            <p>It looks like you're trying to login from a new device. As an added
                                                security mesure, please enter the 4-character code sent to your email.
                                            </p>
                                            <div id="otp" class="">
                                            ...
                                            <p class="text-start resend-code" data-userid="{{ $data->id }}"
                                                data-userrole="{{ $data->usertype }}"> <span style="color: blue;">Resend
                                                    Code</span></p>

                                            <a data-bs-toggle="modal" data-bs-target="#exampleModal"
                                                class="text-start change-mail-id" data-userid="{{ $data->id }}"
                                                data-userrole="{{ $data->usertype }}" data-email="{{ $data->email }}">
                                                Did not get Code? <span style="color: blue;">Change Email</span>
                                            </a>
                                            <div class="mt-4"> <button class="btn btn-danger px-4 validate"
                                                    id="submitButton" data-id="{{$data->id}}"
                                                    data-roleid="{{$data->usertype}}">Submit</button> </div>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
$(document).on('click', '#submitButton', function(e) {
    ...
    $.ajax({
        type: "post",
        url: "/periodical/otpverification",
        data: data,
        dataType: "json",
