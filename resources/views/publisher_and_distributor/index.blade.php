...
<head>
    ...
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('publisher_and_distributor/images/favicon.png') }}">
...
<!-- Style css -->
<link href="{{asset('publisher_and_distributor/css/style.css')}}" rel="stylesheet">
...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="black"
    ...
    ***********************************-->
    ...
    <!-- Dashboard 1 -->
    <script src="{{asset('publisher_and_distributor/js/dashboard/dashboard-1.js')}}"></script>
    ...
    <script src="{{asset('publisher_and_distributor/js/plugins-init/datatables.init.js')}}"></script>
    ...
    <script src="{{asset('publisher_and_distributor/js/custom.js')}}"></script>
    <script src="{{asset('publisher_and_distributor/js/deznav-init.js')}}"></script>
    <script src="{{asset('publisher_and_distributor/js/demo.js')}}"></script>
