...
<html lang="en">
   <head>
      ...
      <!-- PAGE TITLE HERE -->
      <title>Government of Tamil Nadu - Book Procurement - Reject Books List</title>
      <!-- FAVICONS ICON -->
                              ...
                              <tbody>
                                 ...
                                 <td>{{$loop->index+1}}></td>
                                    ...
                                    <td data-label="controlq">
                                          ...
                                          <i class="fa fa-eye"></i>
                                          <a href="/publisher_and_distributor/book_edit/{{$val->id}}" class="btn btn-warning shadow btn-xs sharp me-1">
...
<script>
    $(document).ready(function () {
        ...
        $('#confirmDeleteBtn').on('click', function () {
            ...
            $.ajax({
                url: '/publisher_and_distributor/bookupdatedandreturn',
                method: 'POST',
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        $('#basicModal').modal('hide');
                        setTimeout(function () {
                            window.location.href = "/publisher_and_distributor/book_updatelist"
                        }, 3000);
                    } else {
