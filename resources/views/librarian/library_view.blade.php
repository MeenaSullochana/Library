                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a class="btn btn-primary  btn-sm" href="/librarian/library_list">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-content ">
                                        ...
                                        <div class="row pb-5 ">
										<div class="col-md-6 text-end fw-bold">Library Id : </div>
                                            <div class="col-md-6">{{$data->Librarianid}}</div>
										    ...
										    <div class="col-md-6 text-end fw-bold"> Door No  : </div>
                                            <div class="col-md-6">{{$data->door_no}}</div>

											<div class="col-md-6 text-end fw-bold"> Street  : </div>
                                            <div class="col-md-6">{{$data->street}}</div>

											<div class="col-md-6 text-end fw-bold"> Village  : </div>
                                            <div class="col-md-6">{{$data->Village}}</div>

											<div class="col-md-6 text-end fw-bold"> Post  : </div>
                                            <div class="col-md-6">{{$data->post}}</div>


											<div class="col-md-6 text-end fw-bold"> Taluk  : </div>
                                            <div class="col-md-6">{{$data->taluk}}</div>

											<div class="col-md-6 text-end fw-bold"> District  : </div>
                                            <div class="col-md-6">{{$data->district}}</div>   


											<div class="col-md-6 text-end fw-bold"> Pincode  : </div>
                                            <div class="col-md-6">{{$data->pincode}}</div>

											<div class="col-md-6 text-end fw-bold"> Landmark  : </div>
                                            <div class="col-md-6">{{$data->landmark}}</div>
...
==============================================================================*/
		...
		.card-header-headshot {
			...
			background-image: url('{{ asset('librarian/images/default.png') }}');
			background-size: cover;
			background-position: center center;
