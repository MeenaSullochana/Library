                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>Magazine Order Report Download</b>
                            </h3>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Magazine  Order Report Download</h4>

                            </div>
                            <div class="card-body">
                                <form class="needs-validation" novalidate method="POST"
                                    action="/librarian/magazine_district_order" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
