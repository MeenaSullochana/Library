                                    ...
                                    <table id="example3" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-2">
                                                    <a
                                                        href="/librarian/magazine-view-freq/{{ $val1->id }}/{{ $val1->orderid }}">{{ $val1->title }}</a>
                                                </td>
                                                ...
                                                <td><span>{{$val1->totalorder   -$val1->recived -$val1->notrecived }}</span>
                                                </td>
                                                ...
                                                <td>
                                                    <a
                                                        href="/librarian/magazine-view-freq/{{$val1->id}}/{{$val1->orderid}}">
                                                        <i class="fa fa-eye p-2"></i></a>
...
$(document).ready(function() {
    ...
    function filterLanguage(language) {
        if (language === "") {
            ...
            table.column(1).search(language).draw();
        } else {
