...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Government of Tamil Nadu - Book Procurement - All Meta Periodical Check List</title>
    ...
    ***********************************-->
                        ...
                        <div class="card-body">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <h3 class="mb-0 bc-title">
                                    <b>All Meta Periodical Check List</b>
                                </h3>
                                        ...
                                        <div class="task-summary">
                                            <div class="d-flex align-items-baseline">
                                                <h2 class="text-primary count">
                                                    ...
                                                    $recordCount =
                                                    DB::table('magazines')->where('periodical_reviewer_id','=',$id)->count();
                                                    @endphp
                                                    {{ $recordCount }}
                                                </h2>
                                        ...
                                        <div class="task-summary">
                                            <div class="d-flex align-items-baseline">
                                                <h2 class="text-purple count">
                                                    ...
                                                    $id=auth('librarian')->user()->id;
                                                    $recordCount =
                                                    DB::table('magazines')->where('periodical_reviewer_id','=',$id)->where('periodical_status','=',Null)->count();
                                                    @endphp
                                                    {{ $recordCount }}
                                        ...
                                        <div class="task-summary">
                                            <div class="d-flex align-items-baseline">
                                                <h2 class="text-warning count">
                                                    ...
                                                    $id=auth('librarian')->user()->id;
                                                    $recordCount =
                                                    DB::table('magazines')->where('periodical_reviewer_id','=',$id)->where('periodical_status','=','1')->count();
                                                    @endphp
                                                    {{ $recordCount }}
                                                </h2>
                                        ...
                                        <div class="task-summary">
                                            <div class="d-flex align-items-baseline">
                                                <h2 class="text-danger count">
                                                    ...
                                                    $id=auth('librarian')->user()->id;
                                                    $recordCount =
                                                    DB::table('magazines')->where('periodical_reviewer_id','=',$id)->where('periodical_status','=','0')->count();
                                                    @endphp
                                                    {{ $recordCount }}
                                                </h2>
                                        ...
                                        <div class="task-summary">
                                            <div class="d-flex align-items-baseline">
                                                <h2 class="text-danger count">
                                                    ...
                                                    $id=auth('librarian')->user()->id;
                                                    $recordCount17 =
                                                    DB::table('magazines')->where('periodical_reviewer_id','=',$id)->where('periodical_status','=','2')->count();
                                                    @endphp
                                                    {{ $recordCount17 }}
                                                </h2>
                                                <span>Returned Periodical</span>
                                            </div>
                                            <p>Returned </p>
                                        </div>
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <td>
                                                ...
                                                @else
                                                @php
                                                $data3= DB::table('admins')->find($val->user_id);
                                                ...
                                                @elseif($val->periodical_status=='1')

                                                <td> <span class="badge bg-success text-white">Approved</span></td>
                                                @elseif($val->periodical_status=='2')
                                                ...
                                                <td> <span class="badge bg-danger text-white">Periodical Update To Return
                                                       </span></td>
                                                @else
                                                ...
                                                <td>
                                                    <a href="/librarian/magazine_views/{{$val->id}}"> <i
                                                    ...
                                                    <a class="btn btn-primary mb-2" data-bs-toggle="modal"
                                                        ...
                                                        @elseif($val->periodical_status=='2'     || $val->periodical_status=='3')
                                                        <a class="btn btn-primary mb-2" data-bs-toggle="modal"
                                                        data-id="{{$val->return_message}}"
                                                        data-bs-target="#myModal1">View</a>
                                                    @endif
                                                </td>
                                            </tr>
                                            @endforeach
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Return Periodical Message</h5>
    ...
    <div class="modal fade" id="staticBackdrop22" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog  modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Periodical Correction</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade" id="staticBackdrop1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Periodical Approve </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
...
$(document).on('click', '#submitButton33', function(e) {
    ...
    $.ajax({
        type: "post",
        url: "/librarian/librarianreturnmessage_perio",
        data: data,
        dataType: "json",
        success: function(response) {
            ...
            if (response.success) {
                setTimeout(function() {
                    window.location.href = "/librarian/meta_periodical_list"
                }, 3000);
...
$(document).on('click', '#submitButton', function(e) {
    ...
    $.ajax({
        type: "post",
        url: "/librarian/librarianrejectstatus_perio",
        data: data,
        dataType: "json",
        success: function(response) {
            console.log(response);
...
$(document).on('click', '#submitButton1', function(e) {
    ...
    $.ajax({
        type: "post",
        dataType: "json",
        url: '/librarian/librarianapprovestatus_perio',
        data: data,
        success: function(response) {
