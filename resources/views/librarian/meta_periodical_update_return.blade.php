                        ...
                        <div class="card-body">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <h3 class="mb-0 bc-title">
                                    <b>Update Return Periodical List</b>
                                </h3>
                                    ...
                                    <table id="example4" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <span class="badge bg-danger text-white">Periodical Update To
                                                        Return</span></td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter The Issue Comment" rows="4" cols="5"
                                    class="form-control" id="issueComment" Required>
                            </div>
                        </div>
...
$(document).on('click', '#submitButton33', function(e) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.success) {
                setTimeout(function() {
                    window.location.href = "/librarian/meta_periodical_update_return"
                }, 3000);
