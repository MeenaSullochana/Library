							...
							<div class="card-body">
								...
								<div class="icon-box icon-box-lg bg-success-light rounded-circle">
									...
									<div class="total-projects ms-3">
										<h3 class="text-success count text-start">Book Order Scheme</h3>
                                ...
                                <div class="table-responsive active-projects task-table">
                                    ...
                                    <table id="example3" class="table">
                                        ...
                                        @php
                                            ...
                                            $categories = DB::table('libeaey_budgets')->where('Type','=', 'bookbudget')->where('libraryType','=', $user)->get();
                                            @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/librarian/book_order_scheme_read/{{$val->id}}"> <i class="fa fa-eye p-2"></i></a>
