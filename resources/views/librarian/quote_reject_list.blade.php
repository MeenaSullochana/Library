							...
							<div class="card-body">
								...
								<div class="icon-box icon-box-lg bg-success-light rounded-circle">
									...
									<div class="total-projects ms-3">
										<h3 class="text-danger count text-start">Books Cart Quote Reject List</h3>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="card">
							<div class="card-body">
								<div class="row task">
									<div class="col-xl-3 col-xxl-2 col-sm-12">
									...
									<table id="example" class="table">
										...
										<tbody>
											<tr>
												...
												<td>
                                                    <a href="quote_item_list.php"> <i class="fa fa-eye p-2"></i></a>
													<a href="quote_item_list.php"><i class="fa fa-edit p-2"></i></a>
