                ...
                <div class="card mb-4 mb-4">
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            ...
                            <a class="btn btn-primary  btn-sm" href="/librarian/book_order_list">
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm mb-0 table-striped student-tbl" id="example3">
                                        ...
                                        <tbody id="customers">
                                        @foreach($data->bookProduct as $val)
                                            <tr class="btn-reveal-trigger">
                                                ...
                                                <td>{{$val->quantity}}</td>
                                                <td><i class="fa fa-rupee"></i>{{$val->book_price}}</th>
                                                ...
                                                <td class="py-2 text-end">
                                                    <div class="dropdown"><button
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end border py-0"
                                                            style="">
                                                            <div class="py-2">
                                                            <a class="dropdown-item" href="/librarian/book_view/{{$val->bookid}}"><i class="fa fa-eye p-2"></i>View</a>
