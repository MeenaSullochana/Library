                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="coupon-all">
                                <div class="col-md-12" id="amountdata">
                                                ...
                                                <div class="accordion-item">
                                                    ...
                                                    <div id="collapseOne" class="accordion-collapse collapse hide"
                                                        ...
                                                        <div class="accordion-body">
                                                            <p>Policy and Government Order Review Regularly review the Transparent Book Procurement Policy and government orders for updates <a class="text-center text-success"
                                                                    href="/guidelines">"Read More"</a></p>
