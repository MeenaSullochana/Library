                                ...
                                <div class="col-12">
                                    <div class="coupon-all">
                                        <div class="coupon2">
                                         ...
                                         <a href="/report_downl_cart">   <button class="btn btn-info""  type="submit"><i class="fa fa-file-pdf"></i>Download Excel</button> </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row justify-content-end">
                                ...
                                <div class="col-md-5 ">
                                    <div class="cart-page-total">
                                        ...
                                        <button class="tp-btn tp-color-btn banner-animation" id="Checkoutid">Proceed to Checkout</button>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" id="closwdata" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                   <p id="message">  </p>
                 ...
                 <div class="form-check">
                        <input class="form-check-input" type="radio" name="yesNoRadio" id="flexRadioDefault1" value="yes">
                        <label class="form-check-label" for="flexRadioDefault1" value="no">ஆம்</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="yesNoRadio" id="flexRadioDefault2"  value="no">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" id="closwdata11"  data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <div class="form-check mt-3 w-100">
                            <input class="form-check-input" type="radio" name="overflow_amount" id="option11" value="1">
                            <label class="form-check-label" for="option1">தமிழ் நாடு பாடநூல் மற்றும் கல்வியியல் பணிகள் கழகத்தால் வழங்கப்படும் தொகையிலிருந்து அண்ணா நூற்றாண்டு நூலகம் மூலம் பெறப்படுகிறது.</label>
                        </div>
                        <div class="form-check mt-3 w-100">
                            <input class="form-check-input" type="radio" name="overflow_amount" id="option22" value="0">
                            <label class="form-check-label" for="option2">மேலும் பிற பருவ இதழ்கள் வாங்கப் போதுமான நிதி  இல்லாததால் நிதி ஒப்படைக்கப்படுகிறது.</label>
                        </div>
                        <div class="form-check mt-3 w-100">
                            <input class="form-check-input" type="radio" name="overflow_amount" id="option33" value="0">
                            <label class="form-check-label" for="option3">இந்த பிரிவில் தேவையான இதழ்கள் தேர்வு செய்துவிட்டதால் நிதி ஒப்படைக்கப்படுகிறது.</label>
                        </div>
                    </p>
                </div>
                <div class="modal-footer">
...
<script>
    ...
    $(document).ready(function() {
        $('#Checkoutdata').on('click', function () {
            ...
            toastr.error('Please select an option', { timeout: 2000 });
        }else{
            $('#modalId').modal('hide');
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    console.error('Error occurred while submitting data to the server:', error);
                }
            });
        }
                ...
                success: function(response) {
                    ...
                    if(response.success) {
                        ...
                        if(response.status == '2'){
                            ...
                            document.getElementById('budgetValue').value = response.budgetid;
                            document.getElementById('categoryValue').value = response.category;
                            document.getElementById('messageValue').value = response.error;

                            document.getElementById('budgetValue2').value = response.budgetid;
                            document.getElementById('categoryValue2').value = response.category;
                            document.getElementById('messageValue2').value = response.error;
