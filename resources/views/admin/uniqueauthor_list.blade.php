...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Government of Tamil Nadu - Book Procurement List of Unique Author</title>
    <!-- FAVICONS ICON -->
        ...
        <div class="content-body">
            <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>Unique Author List</b>
                            </h3>
                            <a class="btn btn-primary  btn-sm" href="/admin/uniqueauthor_add">
                                <i class="fas fa-plus"></i> Add Unique Author</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    action="/admin/unique_authorreport" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                                ...
                                <div class="card-body">
                                        ...
                                        <table class="table table-responsive-md" id="example3">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        <strong>Assigned <br>Book Cound</strong>
                                                    </th>
                                                    <th>
                                            ...
                                            <tbody>
                                                {{-- @php
                                                    $unique_authors = DB::table('unique_authors')->get();
                                                @endphp --}}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <span class="w-space-no">{{ $val->book_count }}</span>
                                                            </div>
                                                        </td>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <a href="/admin/uniqueauthor-edit/{{ $val->id }}"
...
<script>
    $(document).ready(function() {
        $('#example3').on('click', '.change-status', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/uniqueauthor_statuschange',
                data: {
                    '_token': '{{ csrf_token() }}',
                    'status': status,
                    'id': id
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        setTimeout(function() {
                            window.location.href = "/admin/uniqueauthor_list"
                        }, 3000);
