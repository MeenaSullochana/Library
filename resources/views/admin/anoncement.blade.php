...
<body>
            ...
            <div class="container-fluid">
                <div class="row p-3 bg-white rounded-2 mb-3">
                    <div class="col-md-12 d-flex justify-content-between">
                        ...
                        <div class="item">
                            <a href="/admin/anouncemenlist"> <button type="button" class="btn btn-primary"><i
                                        ...
                                        <div class="email-left-box dz-scroll pt-3 ps-0" id="email-left">
                                            <div class="mail-list rounded ">
                                                <a class="list-group-item active">
                                                    <i class="fa-regular fa-envelope align-middle"></i>Create
                                                    Announcement </a>
                                                <a href="/admin/anouncemenlist" class="list-group-item">
                                                    <i class="fa-regular fa-paper-plane align-middle"></i>Announcement
                                                    List</a>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <form id="email-form" enctype="multipart/form-data">
                                                        <div class="form-group mt-4">
                                                            ...
                                                            <select class="form-control js-example-tokenizer"
                                                                ...
                                                                <option value='publisher_and_distributor'>Publisher Cum
                                                                    Distributor</option>
                                                                <option value='periodical_publisher'>periodical
                                                                    Publisher</option>
                                                                <option value='periodical_distributor'>periodical
                                                                    Distributor</option>
                                                        ...
                                                        <h5 class="my-3"><i class="fa fa-paperclip me-2"></i> Attachment
                                                        </h5>
                                                        <input type="file" name="attachment" class="form-control"
                                                            id="attachment">
                                                        <div class="text-start mt-4 mb-3">
                                                            <button class="btn btn-primary btn-sl-sm me-2"
                                                                id="submitbutton" type="button"><span class="me-2"><i
    ...
    $(document).ready(function() {
        $("#submitbutton").click(function() {
         ...
         var message = tinymce.get("message").getContent().trim();
        ...
        if (!file) {
            toastr.error("Please uplode a file");
            return; 
        }
