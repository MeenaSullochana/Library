...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Government of Tamil Nadu - Book Procurement List of Periodicalgsm </title>
    <!-- FAVICONS ICON -->
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>  Periodical Gsm  List</b>
                            </h3>
                            <a class="btn btn-primary  btn-sm" href="/admin/periodicalgsm_add">
                                <i class="fas fa-plus"></i> Add  Periodical Gsm</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-12">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-responsive-md" id="example3">
                                            ...
                                            <tbody>
                                            @php
                                             $categori = DB::table('periodicalgsms')->get();
                                             @endphp
        ...
        @endif
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <a href="/admin/periodicalgsm-edit/{{ $val->id }}"
...
<script>
    $(document).ready(function() {
        $('.change-status').on('click', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/periodicalgsm_statuschange',
