...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Government of Tamil Nadu - Book Procurement - Edit Magazine Periodicity</title>
    <!-- FAVICONS ICON -->
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0 bc-title"><b>Edit Magazine Periodicity </b> </h3>
                                         <a class="btn btn-primary btn-sm" href="/admin/magazineperiodicity_list"><i
                                                class="fas fa-chevron-left"></i>Magazine Periodicity List</a>
                                    </div>
                                </div>
                            </div>
...
<script>
        ...
        $("#submitbutton").on("click", function (e) {
            ...
            $.ajax({
                url: "/admin/magazine-eriodicity-edit",
                type: "POST",
                data: formData,
                success: function (response) {
                    ...
                    setTimeout(function() {
                        window.location.href = "/admin/magazineperiodicity_list"
                    }, 3000);
