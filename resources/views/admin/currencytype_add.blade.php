...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Government of Tamil Nadu - Book Procurement Create Currency Type</title>
    <!-- FAVICONS ICON -->
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0 bc-title"><b>Create Currency Type</b> </h3>
                                         <a class="btn btn-primary btn-sm" href="/admin/currencytype_list"><i
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter the Currency Type Name" Required>
                                                    </div>
                                                </div>
          ...
          console.log(formData);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    setTimeout(function() {
                        window.location.href = "/admin/currencytype_add"
                    }, 3000);
