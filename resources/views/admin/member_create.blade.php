                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="col-sm-12 mb-3" id="basic9"
                                                                ...
                                                                <label class="form-label">District<span
                                                                        class="text-danger maditory">*</span></label>
                                                                <select name="district" class="form-select bg-white"
                                                            ...
                                                            <div class="col-sm-12 mb-3" id="basic6"
                                                                style="display: block;">
                                                                <label class="form-label">Name<span
                                                                        class="text-danger maditory">*</span></label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Enter the Name" id="name" required>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-12 mb-3" id="basic8">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="library_code"
                                                                    placeholder="Enter the Library Code"
                                                                    id="library_code" Required>
                                                            </div>

                                                            <div class="col-sm-12 mb-3" id="basic1"
                                                                style="display: block;">
                                                            ...
                                                            <div class="col-sm-12 mb-3" id="basic5"
                                                                ...
                                                                <label class="form-label">Membership Id<span
                                                                        class="text-danger maditory">*</span></label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Enter the Membership Id"
                                                                    id="membershipId" Required>
                                                            </div>

                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="col-sm-12 mb-3" id="basic2"
                                                                style="display: block;">
                                                                <label class="form-label">Designation<span
                                                                        class="text-danger maditory">*</span></label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Enter the Designation" id="designation"
                                                                    Required>
                                                            </div>
                                                            <div class="col-sm-12 mb-3" id="basic3"
                                                                style="display: block;">
                                                                <label class="form-label">Organisation Details <span
                                                                        class="text-danger maditory">*</span></label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Enter the Organisation Details"
                                                                    id="organisationDetails" Required>
                                                            </div>
                                                            <div class="col-sm-12 mb-3" id="basic4"
                                                                style="display: none;">
                                                            ...
                                                            <div class="col-sm-12 mb-3" id="basic7"
                                                                style="display: none;">
                                                                <label class="form-label">Library Name<span
                                                                        class="text-danger maditory">*</span></label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Enter the Library Name"
                                                                    id="libraryName" Required>
                                                            </div>
                                                            <div class="col-sm-12 mb-3" id="basic10"
                                                                style="display: none;">
                                                                ...
                                                                <select class="form-select" id="Category"
                                                                    ...
                                                                    @php
                                                                    $categori =
                                                                    DB::table('special_categories')->where('status','=','1')->get();
                                                                    @endphp
                                                                    @foreach($categori as $val)
                                                                    <option value="{{$val->name}}">{{$val->name}}
                                                                    </option>
                                                            ...
                                                            <div class="col-sm-12 mb-3" id="basic11"
                                                                style="display: none;">
                                                                <label class="form-label">Public Reviewer Name<span
                                                                        class="text-danger maditory">*</span></label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Enter the Public Reviewer Name"
                                                                    id="publicreviewername" Required>
                                                            </div>
                                                            <div class="col-sm-12 mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="col-sm-12 mb-3">
                                                                <label class="form-label">Bank Name<span
                                                                        class="text-danger maditory">*</span></label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Enter Your Bank Name" id="bankName"
                                                                    Required>
                                                            </div>
                                                            <div class="col-sm-12 mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="col-sm-12 mb-3">
                                                                <label class="form-label">Branch<span
                                                                        class="text-danger maditory">*</span></label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Enter Your Branch" id="branch"
                                                                    Required>
                                                            </div>
                                                            <div class="col-sm-12 mb-3">
                                                                <label class="form-label">IFSC Number<span
                                                                        class="text-danger maditory">*</span></label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Enter Your IFSC Number" id="ifscNumber"
                                                                    Required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6 mb-3">
                                                            <label class="form-label">City<span
                                                                    class="text-danger maditory">*</span></label>
                                                            <input type="text" class="form-control"
                                                                placeholder="Enter Your City" id="city" Required>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="door_no"
                                                                placeholder="Enter Your Door No" id="Village" Required>
                                                        </div>
