                            ...
                            <div class="card-body p-3">
                                ...
                                <table class="table table-sm mb-0 table-striped student-tbl" id="example3">
                                        ...
                                        <tbody id="customers">
                                            ...
                                            <td class="py-2">  <a href="/admin/dispatch_magazine_view/{{$val1->id}}/{{$val1->orderid}}"> {{ $val1->title}} </a></td>
											   ...
											   @endif
												<td>
                                                    <a href="/admin/dispatch_magazine_view/{{$val1->id}}/{{$val1->orderid}}"> <i class="fa fa-eye p-2"></i></a>
