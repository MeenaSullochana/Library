...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Government of Tamil Nadu - Book Procurement - Upload Price List</title>
    <!-- FAVICONS ICON -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="">Select The Type </h3>
                                <hr>
                                <div class="row mb-4">
                                    <div class="col-12">
                                        <label class="form-label">Select the Type<span
                                ...
                                <div class="reviewer">
                                    <form class="profile-form" id="formId" action="/admin/book/price" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-validation">
                                            <h3 class="mb-3">Book Price Excel Upload</h3>
                                            <div class="row">
                                                <div class="col-md-6">
                                ...
                                <div class="library">
                                    <form form class="profile-form" id="formId1" action="/admin/library_import" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-validation">
                                        <div class="row" >
                                            <h3 class=""> Magazine Price Upload</h3>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="col-sm-12 mb-3">
                                                        <label class="form-label"></label>
                                                        <input type="file" name="file_magazine_price" class="form-control mb-3" id="file" accept=".xls, .xlsx" required>
