...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Government of Tamil Nadu - Book Procurement - Create Periodical Gsm </title>
    <!-- FAVICONS ICON -->
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0 bc-title"><b>Create Periodical Gsm </b> </h3>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter the Book Paper Finishing Name " required>
                                                    </div>
                                                </div>
          ...
          console.log(formData);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    setTimeout(function() {
                        window.location.href = "/admin/periodicalgsm_add"
                    }, 3000);
