...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Government of Tamil Nadu - Book Procurement - Negotiation Hold List</title>
    <!-- FAVICONS ICON -->
...
<body>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>Negotiation Hold Periodical List</b>
                            </h3>
                                    ...
                                    <table id="example3" class="table dataTable no-footer" role="grid"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="ISBN(10/13): activate to sort column ascending" style="width: 126.609px;">Negotiation Hold  Reason</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td data-label="Message">
                                                <button type="button" id="successButton11" class="btn btn-primary btn-sm" data-id="{{$val->negotiation_hold_message}}">View</button>
                                                </td>
                                                <td>
    ...
    <div class="modal fade" id="exampleModalCenter">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Are you sure you want to send this?</h5>
...
<script>
    $(document).ready(function() {
        $("#submitbutton").click(function() {
            ...
            $.ajax({
                url: '/admin/rejectperiodicalnegotiationstatus',
                method: 'POST',
                data: data,
                success: function(response) {
                    if (response.success) {
