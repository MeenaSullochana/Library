...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Government of Tamil Nadu - Book Procurement List of Magazine Category</title>
    <!-- FAVICONS ICON -->
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>Magazine Category List</b>
                            </h3>
                            <a class="btn btn-primary  btn-sm" href="/admin/magazinecategory_add">
                                <i class="fas fa-plus"></i> Add Magazine Category</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-12">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-responsive-md" id="refresh">
                                            ...
                                            <tbody>
                                            @php
                                             $categori = DB::table('magazine_categories')->get();
                                             @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span class="w-space-no">{{$val->language}}</span>
                                                        </div>
                                                    </td>
        ...
        @endif
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <a href="/admin/magazinecategory-edit/{{ $val->id }}"
...
<script>
    $(document).ready(function() {
        $('#refresh').on('click', '.change-status', function() {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/magazinecategory_statuschange',
...
<script>
        ...
        var id = $(this).data('id');
         console.log(id);
        $.ajax({
            url: '/admin/magazinecategory_delete',
            method: 'POST',
