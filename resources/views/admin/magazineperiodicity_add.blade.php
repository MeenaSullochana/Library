...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Government of Tamil Nadu - Book Procurement - Create Magazine Periodicity</title>
    <!-- FAVICONS ICON -->
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0 bc-title"><b>Create Magazine Periodicity </b> </h3>
...
<script>
        ...
        $("#submitbutton").on("click", function (e) {
          ...
          console.log(formData);
            ...
            $.ajax({
                url: "/admin/magazineperiodicityadd",
                type: "POST",
                data: formData,
                success: function (response) {
                    ...
                    setTimeout(function() {
                        window.location.href = "/admin/magazineperiodicity_add"
                    }, 3000);
