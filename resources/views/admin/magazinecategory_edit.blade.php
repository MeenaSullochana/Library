...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Government of Tamil Nadu - Book Procurement - Edit Magazine Category</title>
    <!-- FAVICONS ICON -->
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0 bc-title"><b>Edit Magazine Category </b> </h3>
                                         <a class="btn btn-primary btn-sm" href="/admin/magazinecategory_list"><i
                                                class="fas fa-chevron-left"></i>Magazine Category List</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card o-hidden border-0 shadow-lg">
                                        <div class="card-body ">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="slug">Magazine Category Name  <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control" id="name" name="name" value="{{$data->name}}" placeholder="Enter the Magazine Category Name" Required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4" id="add">
                                                    <label for="slug">Magazine Category Language <span class="text-danger">*</span></label>
...
<script>
        ...
        $("#submitbutton").on("click", function (e) {
            ...
            $.ajax({
                url: "/admin/magazine-category-edit",
                type: "POST",
                data: formData,
                success: function (response) {
                    ...
                    setTimeout(function() {
                        window.location.href = "/admin/magazinecategory_list"
                    }, 3000);
