                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>Library order Magazine Data</b>
                            </h3>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3  col-sm-6 mb-3 mb-xl-0">
                                            ...
                                            <select name="" id="js-example-matcher" class="form-select bg-white p-2 border border-1 mb-3">
                                                <option value="tamil">Magazine one</option>
                                                <option value="English">Magazine one</option>
                                                <option value="English">Magazine one</option>
                                                <option value="English">Magazine one</option>
                                                <option value="English">Magazine one</option>
                                                <option value="English">Magazine one</option>
                                    ...
                                    <table class="table table-sm mb-0 table-striped student-tbl table-responsive" id="example3">
                                        ...
                                        <tbody id="customers">
                                            <tr class="btn-reveal-trigger">
                                                ...
                                                <td class="py-2">India Today Magazine</td>
                                                <td class="py-2">898</td>
                                                <td class="py-2"> Monthly</td>
                                                <td class="py-2"> <span class="badge bg-primary">Primimum</span></td>
                                                    ...
                                                    <div class="dropdown"><button
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end border py-0"
                                                            ...
                                                            <div class="py-2">
                                                                ...
                                                                <a class="dropdown-item" href="magazine_subscritpion_library"><i class="fa fa-pencil p-2"></i> View library</a>
                                                                <a class="dropdown-item text-danger" href="magazine_subscritpion_library"><i class="fa fa-close p-2"></i> Reject</a>
                                                                ...
                                                                <a class="dropdown-item text-success" data-bs-toggle="modal" data-bs-target="#exampleModal" href="magazine_delete"><i class="fa fa-check p-2"></i>Approve</a></div>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
...
$(document).ready(function(){
    // alert('good');
    $("select#js-example-matcher").select2({
        matcher: matchCustom
    }); 
});
