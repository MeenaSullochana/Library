                                    ...
                                    <table id="example3" class="table dataTable no-footer" role="grid"
                                                    ...
                                                    <div class="products" style="white-space:normal;">
                                                        <div style="white-space:normal;">
                                                            <h6 style="white-space:normal;"><a
                                                                    ...
                                                                    href="/admin/book_manage_view/{{$val->book->id}}">{{$val->book->book_title}}</a>
                                                            </h6>
                                                            <span class="text-left"
                                                                style="white-space:normal;">{{$val->book->subtitle}}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><span>{{$val->book->category}}</span></td>
                                                <td><span>{{$val->book->subject}}</span></td>
                                        ...
                                        <span><a href="#" class="btn btn-danger shadow btn-xs me-1">
                                            View
                                                ...
                                                <td data-label="controlq">
                                                    <div class="d-flex mt-p0">
                                                        <a href="/admin/procur_complete_view/{{$val->book->id}}"
                                                ...
                                                <td>
                                                    <a href="/admin/reviewerlist/{{$val->book->id}}"
