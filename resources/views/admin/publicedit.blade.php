                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <a class="btn btn-primary  btn-sm" href="/admin/reviewer_list">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="col-sm-12 mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    placeholder="Enter public reviewer name"
                                                                    value="{{$data->name}}" id="publicreviewername"
                                                                    Required>
                                                            </div>
                                                            <div class="col-sm-12 mb-3">
                                                                ...
                                                                <select name="district" class="form-select bg-white"
                                                                    ...
                                                                    '=', 1)->where('name','!=',$data->district)->get();
                                                                    @endphp
                                                            ...
                                                            <div class="col-sm-12 mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{$data->membershipId}}" id="membershipId"
                                                                    Required>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="col-sm-12 mb-3">
                                                                ...
                                                                <select class="form-select bg-white" id="Category"
                                                                    ...
                                                                    @php
                                                                    $categori =
                                                                    DB::table('special_categories')->where('status','=','1')->where('name','!=',$data->Category)->get();
                                                                    @endphp
                                                                ...
                                                                <div class="p-5">
                                                                    <div class="author-profile">
                                                                        <div class="author-media">
                                                                            ...
                                                                            <img class="img-ava"
                                                                                src="{{ asset('reviewer/images/default.png') }}"
                                                                                alt="" id="output">
                                                                            @else
                                                                            <img class="img-ava"
                                                                                src="{{ asset('reviewer/ProfileImage/' . $data->profileImage) }}"
                                                                                alt="" id="output">
                                                                            @endif
