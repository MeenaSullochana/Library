...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Government of Tamil Nadu - Book Procurement - Non Negotiation List</title>
    <!-- FAVICONS ICON -->
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive active-projects style-1 ItemsCheckboxSec shorting ">
                                <div class="tbl-caption">
                                    ...
                                    <button class="btn btn-info assignPro mb-5 justify-content-between" data-bs-toggle="modal" data-bs-target="#basicModal1">Approve </button>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        setTimeout(function() {
                            window.location.href = "/admin/non_negotiation_list";
                        }, 3000);
...
<script>
    $(document).ready(function() {
        $("#submitbutton").click(function() {
            ...
            $.ajax({
                url: '/admin/multiapprovenegotiation',
                method: 'POST',
                data: requestData,
                success: function(response) {
