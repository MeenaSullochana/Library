                                    ...
                                    <div class="col-xl-2 col-xxl-3">
                                        <div class="email-left-body">
                                            <div class="email-left-box dz-scroll" id="email-left">
                                                ...
                                                <a class="list-group-item " href="/admin/anouncemenlist">
                                                    ...
                                                    <a href="email-inbox.html" class="list-group-item active"><i
                                                            class="fa-regular fa-envelope align-middle"></i>Announcement  View
                                                    </a>
                                                        ...
                                                        <div class="read-wapper dz-scroll" id="read-content">
                                                            <div class="read-content">
                                                                <div
                                                                    ...
                                                                    @if(auth('admin')->user()->adminImage == null){
                                                                        <img class="me-3 rounded" width="70" height="70"
                                                                            alt="image" src="{{asset("admin/images/default.png")}}">
                                                                       @else

                                                                       <img class="me-3 rounded" width="70" height="70"
                                                                            alt="image" src="{{asset("/admin/AdminImage/".auth('admin')->user()->adminImage)}}">
@endif
                                                                ...
                                                                <div class="media mb-2 mt-3">
																	...
																	<h5 class="my-1 text-primary">to</h5>

																	<p class="read-content-email">
    @foreach($data->to1 as $item)
        @if($item == 'publisher_and_distributor')
            publisher cum distributor<br>
      @else
        {{ $item }}<br>
		@endif
    @endforeach
