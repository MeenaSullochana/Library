...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Government of Tamil Nadu - Book Procurement  - User Forgot Password Page Content</title>
    <!-- FAVICONS ICON -->
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0 bc-title"><b>User Manual Guidelines Content</b> </h3>
                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <form class="admin-form" id="myForm" action="#" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="table-responsive">
                                                        <label for="description">Description Content  <span class="text-danger">*</span></label>
...
$(document).ready(function(){
    $("#submitForm").click(function(){
        var formData = {
            ...
            'descriptionConten': $('input[name="subject[]"]').map(function(){return $(this).val();}).get()
        };
     ...
     console.log(formData);
        $.ajax({
            type: 'POST',
            url: '/admin/manualguidelines',
            data: formData,
            success: function(response) {
                if(response.success){
                toastr.success(response.success,{timeout:45000});
                setTimeout(function() {
                        window.location.href = "/admin/usermanualguidelines"
                    }, 3000);
