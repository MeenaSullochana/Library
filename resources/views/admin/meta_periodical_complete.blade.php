...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Government of Tamil Nadu - Book Procurement - Complete Meta Periodical List</title>
    <!-- FAVICONS ICON -->
                                    ...
                                    <table id="example3" class="table dataTable no-footer" role="grid" aria-describedby="empoloyees-tbl3_info">
                                        <thead>
                                            ...
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="Books: activate to sort column ascending" style="width: 145.219px;">Book Name</th>
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="ERoll No: activate to sort column ascending" style="width: 97.5156px;">Periodicity</th>
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                         $metachecker = DB::table('librarians')->find($val->periodical_reviewer_id);
                                         @endphp
                                           @if( $metachecker != null)
