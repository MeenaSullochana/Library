                                    ...
                                    <table id="example3" class="table dataTable no-footer" role="grid" aria-describedby="empoloyees-tbl3_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="ISBN(10/13): activate to sort column ascending" style="width: 126.609px;">Quotation Creater</th>
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="ISBN(10/13): activate to sort column ascending" style="width: 126.609px;">Quotation Creater Type</th>
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="ISBN(10/13): activate to sort column ascending" style="width: 126.609px;">Distribution Name</th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="Quantity: activate to sort column ascending" style="width: 65.3594px;">Status</th>
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="Quantity: activate to sort column ascending" style="width: 65.3594px;">Distributor</th>

                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="Quantity: activate to sort column ascending" style="width: 65.3594px;">Creater</th>

                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 87.4688px;"> Book</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        @php
                                            $categori = DB::table(DB::raw('(SELECT * FROM books as b WHERE b.marks >= 40 AND b.self_nominated = 1 AND b.negotiation_status = 2) as b'))
    ->join('self_nominated_books as s', 'b.id', '=', 's.book_id')
    ->where('s.status', '=', 1)
    ->select('b.id as book_id', 's.id as self_nominated_id', 'b.*', 's.*')
    ->distinct()
    ->get();
                                            ...
                                            @foreach($categori as $val)
                                               ...
                                               if($val->distributor_type == "distributor"){
                                                    $distributor = DB::table('distributors')->where('id','=',$val->distributed_by)->first();
                                                    $distributionname = $distributor->distributionName;
                                                }else{
                                                    $distributor = DB::table('publisher_distributors')->where('id','=',$val->distributed_by)->first();
                                                    $distributionname = $distributor->publicationDistributionName;
                                                }
                                                if($val->creater_type == "distributor"){
                                                    $creater = DB::table('distributors')->where('id','=',$val->created_by)->first();

                                                }else{
                                                    $creater = DB::table('publisher_distributors')->where('id','=',$val->created_by)->first();
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td><span>
                                                    {{$val->quotation_percentage}}
                                                </span></td>
                                                <td><span>
                                                    {{$val->quotation_price}}
                                                </span></td>
                                                <td>
                                                    <span class="btn btn-danger shadow btn-sm me-1">
                                                        Accepted
                                                    </span>
                                                </td>
                                                <td>
                                                <div class="d-flex mt-p0">
                                                            ...
                                                            @if($val->distributor_type === "publisher")
                                                                <a href="/admin/pub_profile/{{$val->distributed_by}}" class="btn btn-success shadow btn-xs sharp me-1">
                                                                    <i class="fa fa-user"></i>
                                                                </a>
                                                                @elseif($val->distributor_type === "distributor")
                                                                <a href="/admin/dist_profile/{{$val->distributed_by}}" class="btn btn-success shadow btn-xs sharp me-1">
                                                                    <i class="fa fa-user"></i>
                                                                </a>
                                                                @else
                                                                <a href="/admin/publisherdisprofile/{{$val->distributed_by}}" class="btn btn-success shadow btn-xs sharp me-1">
                                                                    <i class="fa fa-user"></i>
                                                                </a>
                                                                @endif
                                                            </div>
                                                ...
                                                <td>
                                                    ...
                                                    @if($val->creater_type === "publisher")
                                                        <a href="/admin/pub_profile/{{$val->created_by}}" class="btn btn-success shadow btn-xs sharp me-1">
                                                            <i class="fa fa-user"></i>
                                                        </a>
                                                        @elseif($val->creater_type === "distributor")
                                                        <a href="/admin/dist_profile/{{$val->created_by}}" class="btn btn-success shadow btn-xs sharp me-1">
                                                            <i class="fa fa-user"></i>
                                                        </a>
                                                        @else
                                                        <a href="/admin/publisherdisprofile/{{$val->created_by}}" class="btn btn-success shadow btn-xs sharp me-1">
                                                            <i class="fa fa-user"></i>
                                                        </a>
                                                        @endif
                                                    </div>
                                                ...
                                                <td data-label="controlq">
                                                    <div class="d-flex mt-p0">
                                                        <a href="/admin/book_manage_view/{{ $val->book_id }}" class="btn btn-success shadow btn-xs sharp me-1">
    ...
    <div class="modal fade" id="uploadModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal Body -->
                <form id="uploadForm" method="POST" action="/admin/quotationstatus" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                 
                        <div class="form-group">
                            <label for="csvFile">Choose CSV File:</label>
                            <input type="file" class="form-control mb-2" name="quotationfile" id="file" accept=".csv" required>
