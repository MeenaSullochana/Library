                                    ...
                                    <table class="table table-sm mb-0 table-striped student-tbl" id="example3">
                                        <thead>
                                            <tr>
                                                <th>S.No</th>
                                                <th>Title</th>
                                                <th>Periodicity (no. of issues)</th>
                                                <th>Order Id</th>
                                                <th>Library Category</th>
                                                <th>Approximate Quantity</th>
                                                <th>Cover Price Per Issue(Rs.)</th>
                                                <th>Annual Subscription for Individual Users (Rs.)</th>
                                                <th>Quoted Price Per Issue(Rs.)</th>
                                                <th>Quoted Price Per Issue for 1 Year to Libraries (Rs.) </th>
                                                <th>% of Discount</th>
                                                <th>RNI Details</th>
                                                <th>Total Number of Pages </th>
                                                <th> No. of Multi Colour Pages</th>
                                                <th>No. of Mono Colour Pages </th>
                                                <th>  Quality of Paper
                                                    (GSM / Map Litho / Art Paper, etc.,)
                                                    </th>
