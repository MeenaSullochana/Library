...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Government of Tamil Nadu - Book Procurement Categories Edit</title>
    <!-- FAVICONS ICON -->
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0 bc-title"><b>Edit Category</b> </h3>
                                        <a class="btn btn-primary btn-sm" href="/admin/categories_list"><i
                                                            ...
                                                            <div class="p-1">
                                                                <div class="author-profile">
                                                                    ...
                                                                    <div class="author-info">
                                                                        <h6 class="title">Edit Category Image</h6>
                                                                    </div>
                                                                </div>
