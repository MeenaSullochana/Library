...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Government of Tamil Nadu - Book Procurement - Categories Add</title>
    <!-- FAVICONS ICON -->
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a class="btn btn-primary btn-sm" href="categories_list"><i
                                    ...
                                    <div class="card o-hidden border-0 shadow-lg">
                                        <div class="card-body ">
                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="clearfix">
                                                    <div class="card card-bx profile-card author-profile m-b30 mt-3">
                                                        
                                                            <div class="p-1">
                                                                <div class="author-profile">
                                                                    <div class="author-media">
                                                                        <img src="images/user.jpg" alt="user-profile" id="output" >
