...
<head>
   ...
   <!-- PAGE TITLE HERE -->
   <title>Government of Tamil Nadu - Book Procurements</title>
   <!-- FAVICONS ICON -->
                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>Publisher/Distributor Active List</b>
                            </h3>
  ...
  $(function() {
    $('.toggle-class').change(function(e) {
        ...
        $.ajax({
            type: "post",
            dataType: "json",
            url: '/admin/pubdiststatus',
            data: {'status': status, 'pubdistid': pubdistid},
            success: function(response) {
               if(response.success){
                setTimeout(function() {
                    window.location.href ="/admin/publisher_and_dis_active_list"
                     }, 3000);
