                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>Library Dispatch  Not Yet Completed</b>
                            </h3>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Library Dispatch  Not Yet Completed</h4>

                            </div>
                            <div class="card-body">
                                <form class="needs-validation" novalidate method="POST"
                                    action="/admin/Dispatch_library_report" enctype="multipart/form-data">
                                    @csrf
