...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Government of Tamil Nadu - Book Procurement - Pending Meta Periodical List</title>
    <!-- FAVICONS ICON -->
                                ...
                                <div id="empoloyees-tbl3_wrapper" class="dataTables_wrapper no-footer">
                                    <table id="example3" class="table dataTable no-footer" role="grid" aria-describedby="empoloyees-tbl3_info">
                                        ...
                                        <tbody>
                                         ...
                                         @php
                                             $metachecker = DB::table('librarians')->where('id', $val->periodical_reviewer_id)->first();
                                        @endphp
