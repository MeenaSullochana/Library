...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Government of Tamil Nadu - Book Procurement - List of Currency Type</title>
    <!-- FAVICONS ICON -->
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>List of Currency Type</b>
                            </h3>
                            <a class="btn btn-primary  btn-sm" href="/admin/currencytype_add">
                                <i class="fas fa-plus"></i> Add Currency Type</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-12">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-responsive-md" id="example3">
                                            ...
                                            <tbody>
                                            @php
                                             $categori = DB::table('currency_type')->get();
                                             @endphp
        ...
        @endif
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <a href="/admin/currencytype-edit/{{ $val->id }}"
