...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Government of Tamil Nadu - Book Procurement - Book GSM Create</title>
    <!-- FAVICONS ICON -->
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter the Book GSM Number" required>
                                                    </div>
                                                </div>
          ...
          console.log(formData);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    setTimeout(function() {
                        window.location.href = "/admin/bookgsm_add"
                    }, 3000);
