...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Government of Tamil Nadu - Book Procurement - User Register Page Content</title>
    <!-- FAVICONS ICON -->
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0 bc-title"><b>Add Mail Verification Page Content</b> </h3>
...
$(document).ready(function(){
    $("#submitForm").click(function(){
     ...
     console.log(formData);
        $.ajax({
            type: 'POST',
            url: '/admin/mailverification_title',
            data: formData,
            success: function(response) {
                if(response.success){
                toastr.success(response.success,{timeout:45000});
                setTimeout(function() {
                        window.location.href = "/admin/mailverificationcontent"
                    }, 3000);
