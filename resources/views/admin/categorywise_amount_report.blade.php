...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Government of Tamil Nadu - Book Procurement - Category Wise Amount  Report Download</title>
    <!-- FAVICONS ICON -->
                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b> Category Wise Amount Data Report Download</b>
                            </h3>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Category Wise Amount Data Report Download</h4>
                            ...
                            <div class="card-body">
                                ...
                                action="/admin/category_wise_amount_report" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
