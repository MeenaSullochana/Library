...
<body>
                                    ...
                                    <table id="example3" class="table dataTable no-footer" role="grid" aria-describedby="empoloyees-tbl3_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="ISBN(10/13): activate to sort column ascending" style="width: 126.609px;">Rejected Quoters Count</th>
    ...
    ->where('s.status', '=', 2)
    ->select('b.*','s.created_by','s.creater_type')
    ->distinct()
    ->get();
                                            ...
                                            @foreach($categori as $val)
                                                  @php
                                                      $count = DB::table('self_nominated_books')->where('book_id','=',$val->id)->where('status','=',2)->count();
                                                if($val->creater_type == "distributor"){
                                                    $user = DB::table('distributors')->where('id','=',$val->created_by)->first();

                                                }else{
                                                    $user = DB::table('publisher_distributors')->where('id','=',$val->created_by)->first();
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                      ...
                                                      <a href="/admin/self_creater_failed_view/{{ $val->id }}" class="btn btn-primary btn-sm">
                                                           View
                                                        </a>
                                                </td>
