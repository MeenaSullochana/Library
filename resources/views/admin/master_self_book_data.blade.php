                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>Master Self Nominated Book Data</b>
                            </h3>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <div class="row mb-4 d-flex">
                                    <div class="col-xl-3 col-sm-6 mb-3 mb-xl-0">
                                        ...
                                        <select name="language_filter" id="language_filter" class="form-select bg-white p-2 border border-1 mb-3">
                                            ...
                                            <option value="Tamil" {{ request('language_filter') == 'Tamil' ? 'selected' : '' }}>Tamil</option>
                                            <option value="English" {{ request('language_filter') == 'English' ? 'selected' : '' }}>English
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-xl-3 col-sm-6 mb-3 mb-xl-0">
                                        <label class="form-label">Select Subject</label>
                                        <select name="subject_filter" id="subject_filter" class="form-select bg-white p-2 border border-1 mb-3">
                                            <option value="">All Subject</option>
                                            @php
                                            $subjects = DB::table('book_subject')->get();
                                            @endphp
                                            @foreach($subjects as $subject)
                                            <option value="{{ $subject->name }}" {{ request('subject_filter') == $subject->name ? 'selected' : '' }}>
                                                {{ $subject->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-xl-3 col-sm-6 mb-3 mb-xl-0">
                                        ...
                                        <select name="category_filter" id="category_filter" class="form-select bg-white p-2 border border-1 mb-3">
                                            ...
                                            <option value="{{ $category->name }}" {{ request('category_filter') == $category->name ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-xl-3 col-sm-6 mb-3 mb-xl-0">
                                        <label class="form-label">Select Quotation Status</label>
                                        <select name="quotation_filter" id="quotation_filter" class="form-select bg-white p-2 border border-1 mb-3">
                                            <option value="">All </option>
                                            <option value="Quoted">Quoted Books</option>
                                            <option value="Not Yet Quoted">Not Yet Quoted Books</option>
                                            <option value="Completed">Completed Books</option>
                                          
                                        </select>
                                    </div>
                                    <div class="col-xl-3 col-sm-6 mb-3 mb-xl-0">
                                        <label class="form-label">Select User Type</label>
                                        <select name="usertype_filter" id="usertype_filter" class="form-select bg-white p-2 border border-1 mb-3">
                                            <option value="">All </option>
                                    ...
                                    <div class="col-xl-3 col-sm-6 mb-3 mb-xl-0">
                                        ...
                                        <input type="text" name="search" id="search" class="form-control" value="{{ request('search') }}" placeholder="Search by title or ISBN">
                                    </div>

                                    <div class="col-xl-3 col-sm-6 mb-3 mb-xl-0 mt-4">
                                        <button type="button" onclick="submitForm('action2')" class="btn btn-primary">Filter</button>
                                    </div>
                                    <div class="col-xl-3 col-sm-6 mb-3 mb-xl-0 mt-4">
                                        <button type="button" onclick="submitForm('action1')" class="btn btn-primary">Download</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table shorting dataTable no-footer" role="grid" aria-describedby="user-tbl_info">
                                <thead>
                                    <tr role="row">
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <div>
                                                <span>Creater Type</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <span>Creater Distribution Name</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                        ...
                                        <td>
                                            <div>
                                                <span>Distributor Distribution Name </span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <span>Quotation Percentage</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
...
<script>
    function submitForm(action) {
        ...
        if (action === 'action1') {
            ...
            form.action = '/admin/master_self_book_datareport';
        } else if (action === 'action2') {

            form.action = '/admin/master_self_book_data';
...
<!-- <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.submitForm = submitForm; // Make the function accessible globally
        });
    </script> -->