...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Government of Tamil Nadu - Book Procurement Edit Periodical Gsm </title>
    <!-- FAVICONS ICON -->
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h3 class="mb-0 bc-title"><b>Edit Periodical Gsm</b> </h3>
                                        <a class="btn btn-primary btn-sm" href="/admin/periodicalgsm_list"><i
                                    ...
                                    <div class="card o-hidden border-0 shadow-lg">
                                        <div class="card-body ">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="slug">Periodical Gsm Name  <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter the Book Paper Finishing Name" value="{{$data->name}}" Required>
                                                    </div>
                                                </div>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    setTimeout(function () {
                        window.location.href = "/admin/periodicalgsm_list"
                    }, 3000);
