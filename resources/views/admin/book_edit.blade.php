                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a class="btn btn-primary  btn-sm" href=" {{ url('admin/book_manage_all') }}">
                                <i class="fa fa-angle-double-left" aria-hidden="true"></i> List of Book </a>
                        </div>
                    </div>
                </div>
                <form class="row g-3 mt-2" method="POST" enctype="multipart/form-data" id ="ourFormId" action="/admin/update/book"
                    autocomplete="on">
                    @csrf
                                        ...
                                        <div class="mb-3">
                                            <label class="text-label form-label text-black"
                                                ...
                                                <input type="text" class="form-control" id="nameOfPublisher"
                                                    name="nameOfPublisher" placeholder="Enter the Name of Publisher" value="{{$data->nameOfPublisher}}" 
                                                  >
...
$('.highlights_delete').on('click', function() {
    ...
    $.ajax({
        url: "/admin/remove-image-highlights",
        type: "POST",
        dataType: "json",
        data: {
            _token: "{{ csrf_token() }}",
