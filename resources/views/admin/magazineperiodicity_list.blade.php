                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a class="btn btn-primary  btn-sm" href="/admin/magazinePeriodicity_add">
                                <i class="fas fa-plus"></i> Add Magazine Periodicity</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-12">
        ...
        @endif
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <a href="/admin/magazineperiodicity-edit/{{ $val->id }}"
...
<script>
    $(document).ready(function() {
        $('#refresh').on('click', '.change-status', function() {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/magazineperiodicity_statuschange',
...
<script>
    ...
    $('#refresh').on('click', '.delete-btn', function() {
        ...
        var id = $(this).data('id');
         console.log(id);
        $.ajax({
            url: '/admin/magazineperiodicity_delete',
            method: 'POST',
