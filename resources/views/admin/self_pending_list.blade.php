...
<body>
                                    ...
                                    <table id="example3" class="table dataTable no-footer" role="grid" aria-describedby="empoloyees-tbl3_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="ISBN(10/13): activate to sort column ascending" style="width: 126.609px;">Quoters Count</th>
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="ISBN(10/13): activate to sort column ascending" style="width: 126.609px;">Quotation Creators</th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="Quantity: activate to sort column ascending" style="width: 65.3594px;">Export Report</th>
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="Quantity: activate to sort column ascending" style="width: 65.3594px;">Excel Upload(.csv)</th>
                                        ...
                                        <tbody>
                                            @php
                                            $categori = DB::table(DB::raw('(SELECT * FROM books as b WHERE b.marks >= 40 AND b.self_nominated = 1 AND b.negotiation_status = 0) as b'))
    ...
    ->get();
                                            ...
                                            @foreach($categori as $val)
                                                  @php
                                                      $count = DB::table('self_nominated_books')->where('book_id','=',$val->id)->count();
                                                  @endphp
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                      ...
                                                      <a href="/admin/self_creater_view/{{ $val->id }}" class="btn btn-primary btn-sm">
                                                           View
                                                        </a>
                                                </td>
    ...
    <a href="/admin/self_export/{{ $val->id }}" class="btn btn-success btn-sm" style="background-color: #46d109a8 !important;">
        Export
    </a>
</td>
                                                <td data-label="Message">
                                                <button type="button" id="uploadbtn" class="btn btn-success btn-sm" data-toggle="modal" data-target="#uploadModal" style="background-color: #46d109a8 !important;">Upload</button>
                                                </td>
