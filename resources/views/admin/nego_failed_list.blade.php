                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3"
                                                    rowspan="1" colspan="1"
                                                    aria-label="ERoll No: activate to sort column ascending"
                                                    style="width: 97.5156px;">Book Code</th>
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3"
                                                    rowspan="1" colspan="1"
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3"
                                                    ...
                                                    style="width: 126.609px;">Actual Price</th>

                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3"
                                                    rowspan="1" colspan="1"
                                                    aria-label="ISBN(10/13): activate to sort column ascending"
                                                    style="width: 126.609px;">Discount Percentage</th>
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3"
                                                    rowspan="1" colspan="1"
                                                    aria-label="ISBN(10/13): activate to sort column ascending"
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <div class="products">
                                                        <div>
                                                            <h6><a style="white-space:normal;"   class="text-left"
