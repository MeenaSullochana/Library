...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Government of Tamil Nadu - Book Procurement - Negotiation Uplode Report Download</title>
    <!-- FAVICONS ICON -->
                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b> Negotiation Data Report Download</b>
                            </h3>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    action="/admin/negotiation_data_reports" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 mb-12">
                                                     <label class="form-label">Negotiation Type<span
                                                        ...
                                                        <select name="type" class="form-select bg-white" id="type" Required>
                                                           ...
                                                           <option value="No_Negotiation"> Non Negotiation</option>
