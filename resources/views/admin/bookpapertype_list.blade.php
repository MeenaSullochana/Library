...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Government of Tamil Nadu - Book Procurement List of Book Paper Type</title>
    <!-- FAVICONS ICON -->
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a class="btn btn-primary  btn-sm" href="/admin/bookpapertype_add">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-responsive-md" id="example3">
                                            ...
                                            <tbody>
                                            @php
                                             $categori = DB::table('book_papertype')->get();
                                             @endphp
        ...
        @endif
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <a href="/admin/bookpapertype-edit/{{ $val->id }}"
...
<script>
    ...
    $('.delete-btn').on('click', function () {
        ...
        var id = $(this).data('id');
         console.log(id);
        $.ajax({
            url: '/admin/book_papertype_delete',
            method: 'POST',
