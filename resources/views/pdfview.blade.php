        ...
        <table class="mt-3">
            ...
            @foreach ($publisher as $publisher)
                <tr>
                    ...
                    <td>{{ $publisher->publicationName }}</td>
                    <td>{{ $publisher->firstName }} {{ $publisher->lastName }}</td>
                    <td>{{ $publisher->email }}</td>
                    <td>{{ $publisher->mobileNumber }}</td>
                    <td>{{ $publisher->publicationAddress }}</td>
                    <td>{{ $publisher->country }}</td>
                    <td>{{ $publisher->state }}</td>
                    <td>{{ $publisher->District }}</td>
                    <td>{{ $publisher->city }}</td>
                    <td>{{ $publisher->postalCode }}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
