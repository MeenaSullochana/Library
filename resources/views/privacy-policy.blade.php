...
<body>
    ...
    <main>
        ...
        <!-- about-area-start -->
        <section class="about-area tpabout__inner-bg pt-75 pb-170 mb-50" data-background="assets/img/banner/1.png">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
        ...
        <section>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Tamil Nadu Book Procurement.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Tamil Nadu Book Procurement, accessible from <a
                            href="https://bookprocurement.tamilnadupubliclibraries.org/"
                            rel="external nofollow noopener"
                            target="_blank">https://bookprocurement.tamilnadupubliclibraries.org/</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>
                    <p>By email: lbrnioaclchn.dopl@tn.gov.in</p>
                </li>
                <li>
                    <p>By visiting this page on our website: <a
                            href="https://bookprocurement.tamilnadupubliclibraries.org/contact-us"
                            rel="external nofollow noopener"
                            target="_blank">https://bookprocurement.tamilnadupubliclibraries.org/contact-us</a></p>
                </li>
            </ul>
            </div>
        </section>
...
<style>
    ...
    @media only screen and (max-width: 600px) {
        section.about-area.tpabout__inner-bg.pt-75.pb-170.mb-50 {
