						...
						<nav class="navbar navbar-expand">
							<div class="collapse navbar-collapse justify-content-between">
								<div class="header-left">
									<h4 class="ms-5"><b>{{auth('periodical_distributor')->user()->distributionName}}</b></h4>
								</div>
											...
											<div class="dropdown header-profile2">
												<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
													<div class="header-info2 d-flex align-items-center">
														...
														@if(auth('periodical_distributor')->user()->profileImage == Null)
																<img  src="{{asset("images/default.png")}}"  alt="">
		
																@else
																<img id="navprofileImage" src="{{asset("periodical_distributor/images/profile/".auth('periodical_distributor')->user()->profileImage)}}"  alt="">
														...
														<div class="card-header py-2">
															<div class="products">
															  @if(auth('periodical_distributor')->user()->profileImage == Null)
																...
																@else
																<img  src="{{asset("periodical_distributor/images/profile/".auth('periodical_distributor')->user()->profileImage)}}" class="avatar avatar-md" alt="">
		
																@endif
																<div>
																	<h6>{{auth('periodical_distributor')->user()->firstName}}   {{auth('periodical_distributor')->user()->lastName }}</h6>
																	<span>{{auth('periodical_distributor')->user()->email }}</span>
																</div>
															</div>
														</div>
														<div class="card-body px-0 py-2">
															<a href="/periodical_distributor/distributor_profile_view" class="dropdown-item ai-icon ">
															...
															<a href="/periodical_distributor/change_password" class="dropdown-item ai-icon ">
																<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															...
															<a href="/periodical_distributor/notification" class="dropdown-item ai-icon ">
																<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="deznav">
					<div class="deznav-scroll">
						<ul class="metismenu" id="menu">
							...
							<li><a href="/periodical_distributor/index" class="" aria-expanded="false">
							...
							<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
							 <i class="bi bi-journal-plus"></i>
								...
								<ul aria-expanded="false">
									<li><a href="/periodical_distributor/Magazine_add">Magazine Add</a></li>
					...
					<i class="bi bi-basket"></i>
                        ...
                        <ul aria-expanded="false">
                           ...
                           <li><a href="/periodical_distributor/periodical_procurement_list">Pending List </a></li>
							<li><a href="/periodical_distributor/periodical_updatelist">Return Correction Book List</a></li>
							<li><a href="/periodical_distributor/periodical_procurement_return_update">Return To Meta Check</a></li>
                            <li><a href="/periodical_distributor/periodical_procurement_complete">Screened List </a></li>
                            <li><a href="/periodical_distributor/periodical_procurement_reject">Reject List </a></li> 
                        </ul>
                    </li>
							<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
