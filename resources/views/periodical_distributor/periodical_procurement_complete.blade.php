...
<html lang="en">
   <head>
      ...
      <!-- PAGE TITLE HERE -->
      <title>Government of Tamil Nadu - Book Procurement - Complete Periodical List</title>
      <!-- FAVICONS ICON -->
                  ...
                  <div class="card-body">
                     <div class="d-sm-flex align-items-center justify-content-between">
                        <h3 class="mb-0 bc-title">
                           <b>Completed Periodicals List</b>
                        </h3>
                  ...
                  <div class="card-body p-0">
                     <div class="table-responsive active-projects style-1 ItemsCheckboxSec shorting ">
                        <div class="tbl-caption">
                           <span class="h5"><span class="h5 text-danger">Note :</span> Your Periodicals are under Review process</span>
                       </div>
                       ...
                       <table id="all-export" class="display table" style="min-width: 845px">
                              <thead>
                                 <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1"
                                       colspan="1"
                                       aria-label="Periodical: activate to sort column ascending"
                              ...
                              <tbody>
                                 ...
                                 <tr role="row" class="odd">
                                    ...
                                    <td data-label="Title" class="tdbreak">
                                       <div>

                                             <h6><a class="text-left" href="/periodical_distributor/book_mmagazine_viewanage_view/{{$val->id}}">{{$val->title}}</a></h6>
