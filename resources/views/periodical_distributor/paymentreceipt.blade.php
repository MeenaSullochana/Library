                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="print-section">
                                <a class="btn btn-primary  btn-sm" href="/periodical_distributor/procurement_payment_list">
                ...
                <div class="card" id="print-pdf">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <h4 class="text-center pt-2" >Transparent Periodical Procurement Portal <br> Review Fee for Periodical Selection</h4>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table responsive mt-5">
                                        ...
                                        <tbody>
                                        @php
                                            $magazinedata= json_decode($data->bookId);
                                            @endphp
                                            @foreach($magazinedata as $val)
                                            @php
                                            $magazines = DB::table('magazines')->find($val);
                                            @endphp
                                                <tr role="row" class="odd">
                                                    <td><span>{{$loop->index +1}}</span></td>
                                                   
                                                    <td>{{$magazines->title}}</td>
                                                    <td>{{$magazines->rni_details}}</td>
                                                    <td>1</td>
                        ...
                        <p class="text-center"><span class="text-danger ">Note:</span> Review Fee for Periodical Selection is Non Refundable.</p>
                    </div>
                </div>
            </div>
        </div>
