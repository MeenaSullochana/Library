                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>Negotiation - Holding Periodical List</b>
                            </h3>
                                    ...
                                    <table id="example4" class="table dataTable no-footer" role="grid" aria-describedby="empoloyees-tbl3_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="ISBN(10/13): activate to sort column ascending" style="width: 126.609px;">Negotiation <br> Percentage</th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1" colspan="1" aria-label="ISBN(10/13): activate to sort column ascending" style="width: 126.609px;">Reason For Hold</th>
                                        ...
                                        <tbody>
                                            ...
                                            $categori = DB::table('magazines')->where('marks', '>=', 40)->where('user_id', '=', $id)->where('negotiation_status', '=', 4)->get();
                                            @endphp
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td data-label="Title">
                                                    <div class="products">
                                                        <h6><a class="text-left" href="/periodical_periodical_distributor/magazine_view">{{ $val->title }}</a></h6>
                                                    </div>
                                                </td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Are you sure to send this book to negotiation ?</h5>
...
<script>
    $(document).ready(function() {
        $('#example4').on('click', '#successButton11', function() {
...
<script>
    $(document).ready(function() {
        $('#example4').on('click', '#successButton111', function() {
            var message = $(this).data('id');
            console.log(message);
...
<script>
    $(document).ready(function() {
        $('#example4').on('click', '#successButton112', function() {
            var message = $(this).data('id');
            console.log(message);
...
<script>
    $(document).ready(function() {
        ...
        $("#submitbutton11").click(function() {
            ...
            $.ajax({
                url: '/periodical_distributor/sendnegotiationstatus',
                method: 'POST',
                data: {
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        setTimeout(function() {
                            window.location.href = "/periodical_distributor/nego_hold";
                        }, 3000);
...
<script>
    $(document).ready(function() {
        $("#submitbutton").click(function() {
            ...
            $.ajax({
                url: '/periodical_distributor/sendnegotiationsamount',
                method: 'POST',
                data: data,
                success: function(response) {
                    if (response.success) {
                        ...
                        setTimeout(function() {
                            window.location.href = "/periodical_distributor/nego_pending_list";
                        }, 3000);
                        toastr.success(response.success, {
                            timeout: 45000
                        });
