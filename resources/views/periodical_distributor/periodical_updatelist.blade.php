...
<html lang="en">
   <head>
      ...
      <!-- PAGE TITLE HERE -->
      <title>Government of Tamil Nadu - Book Procurement - Reject Periodicals List</title>
      <!-- FAVICONS ICON -->
                           ...
                           <table id="example4" class="dataTable no-footer" role="grid"
                              ...
                              <thead>
                                 ...
                                 <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1"
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1"
                                       colspan="1"
                                       aria-label="Periodicals: activate to sort column ascending"
                                       style="width: 145.219px;">Periodical Title</th>
                                       <th class="sorting" tabindex="0" aria-controls="empoloyees-tbl3" rowspan="1"
                                       colspan="1" aria-label="ERoll No: activate to sort column ascending"
                                       style="width: 97.5156px;">Periodicity Name</th>
                              ...
                              <tbody>
                                 ...
                                 $id=auth('periodical_distributor')->user()->id;
                                   $data=DB::table('magazines')->where('user_id','=',$id)->where('periodical_procurement_status','=',"1")->where('periodical_status','=',"2")->get();
                                 @endphp
                                 ...
                                 <td>{{$loop->index+1}}></td>
                                    ...
                                    <td data-label="periodicity">{{$val->periodicity}}</td>
                                    ...
                                    <td data-label="controlq">
                                          ...
                                          <i class="fa fa-eye"></i>
                                          <a href="/periodical_distributor/magazine_edit/{{$val->id}}" class="btn btn-warning shadow btn-xs sharp me-1">
...
<script>
    $(document).ready(function () {
        ...
        $('#confirmDeleteBtn').on('click', function () {
            ...
            $.ajax({
                url: '/periodical_distributor/periodicalupdatedandreturn',
                method: 'POST',
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        $('#basicModal').modal('hide');
                        setTimeout(function () {
                            window.location.href = "/periodical_distributor/periodical_updatelist"
                        }, 3000);
                    } else {
