                                 ...
                                 <td>{{$loop->index+1}}></td>
                                    <td>
                                       <div >
                                             ...
                                             <h6><a class="text-left" href="/periodical_distributor/book_manage_view/{{$val->id}}">{{$val->title}}</a></h6>
                                    ...
                                    <td data-label="periodicity">{{$val->periodicity}}</td>
                                           ...
                                           <td>
                                        <a class="badge bg-success">Return To Metacheck</a>
                                                   </td>
                                               </a>
                                               <td>
...
<script>
    $(document).ready(function () {
        ...
        $('#confirmDeleteBtn').on('click', function () {
            ...
            $.ajax({
                url: '/periodical_distributor/bookupdatedandreturn',
                method: 'POST',
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        $('#basicModal').modal('hide');
                        setTimeout(function () {
                            window.location.href = "/periodical_distributor/book_updatelist"
                        }, 3000);
                    } else {
