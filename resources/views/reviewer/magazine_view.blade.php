                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <!-- <a class="btn btn-primary  btn-sm" href=" {{ url('reviewer/magazine_list') }}">
...
<script>
        $(document).ready(function() {
            $('#saveButton').click(function() {
                ...
                var reviewerId = $(this).data('revid');


                window.location.href = '/reviewer/review_post_periodical/' + dataId + '/' + reviewerId;
            });
        });
        </script>
