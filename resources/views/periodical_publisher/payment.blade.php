                        ...
                        <div class="card mb-4 h-auto">
                            <div class="card-body">
                                <div class="mb-3 d-flex justify-content-end ">
                                    ...
                                    <div class="d-flex ">
                                        <button class="btn btn-link p-0 me-3 btn-icon-text" onclick="generatePdf()"><i
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a class="dropdown-item" href="/publisher/procurement"><i class="bi bi-pencil"></i>
                                                        Edit</a></li>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless" id="print-pdf" style="min-width: 200px">
                                        <thead>
                                            <tr>
                                                <th>S/No</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $val)
                                                <tr>
                                                    ...
                                                    <td data-label="Amount" class=""><i class="fa fa-inr"> 450</td>
                                                </tr>
                                            @endforeach
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="fw-bold">
                                                <td>TOTAL</td>
                                                <td class="text-end"><i class="fa fa-inr"> {{ count($data) * 450 }}</td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
                                        <div class="card">
                                            <div class="card-body text-center ai-icon  text-primary">
                                                {{-- <svg xmlns="http://www.w3.org/2000/svg" width="6.51em" height="6em"
                                                    viewBox="0 0 512 204">
                                                    <path fill="#5F6368"
                                                        d="M362.927 55.057c14.075 0 24.952 3.839 33.27 11.517c8.317 7.677 12.155 17.914 12.155 30.71v61.42h-17.914V144.63h-.64c-7.677 11.517-18.554 17.275-31.35 17.275c-10.877 0-20.474-3.2-28.151-9.597c-7.038-6.398-11.517-15.355-11.517-24.952c0-10.237 3.84-18.555 11.517-24.953s18.554-8.957 31.35-8.957c11.516 0 20.474 1.92 27.511 6.398v-4.478c0-5.972-2.229-11.943-6.688-15.834l-.99-.801c-5.118-4.479-11.516-7.038-18.553-7.038c-10.877 0-19.194 4.479-24.953 13.436L321.34 74.89c10.236-13.436 23.672-19.834 41.587-19.834M272.715 11.55c11.48 0 22.39 3.995 31.113 11.445l1.517 1.35c8.957 7.678 13.435 19.195 13.435 31.351c0 12.156-4.478 23.033-13.435 31.35c-8.958 8.318-19.834 12.796-32.63 12.796l-30.71-.64v59.502H222.81V11.55zm92.77 97.25c-7.677 0-14.075 1.919-19.193 5.758c-5.119 3.199-7.678 7.677-7.678 13.435c0 5.119 2.56 9.597 6.398 12.157c4.479 3.199 9.597 5.118 14.716 5.118c7.165 0 14.331-2.787 19.936-7.84l1.177-1.117c6.398-5.758 9.597-12.796 9.597-20.474c-5.758-4.478-14.076-7.038-24.952-7.038m-91.49-79.336h-31.99V80.65h31.99c7.037 0 14.075-2.559 18.554-7.677c10.236-9.597 10.236-25.592.64-35.19l-.64-.64c-5.119-5.118-11.517-8.317-18.555-7.677M512 58.256l-63.34 145.235h-19.194l23.672-50.544l-41.587-94.051h20.474l30.07 72.297h.64l29.431-72.297H512z" />
                                                    <path fill="#4285F4"
                                                ...
                                                <a href="/salesapi" class="btn my-2 btn-primary btn-lg px-4"
                                                    id="idbi"> Pay Now</a>
                                            </div>
                                        </div>
                                    </div>
