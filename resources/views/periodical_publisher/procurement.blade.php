...
<body>
                                    ...
                                    <table id="example3" class="" role="grid" style="min-width: 200px"
                                        ...
                                        <tbody>
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td  data-label="Book ID">52424127</td>
                                                    <td style="white-space:normal;" data-label="Title">
                                                        <h6><a class="text-left" href="#">சத்திய சோதனை</a></h6>
                                                        <span class="text-left">மகாத்மா காந்தி சுயசரிதை</span>
                                                    </td>
                                                    <td data-label="Author">மஹாத் தேசாய்</td>
                                                    <td data-label="ISBN">9789389931457</td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title">Are you send this magazine to magazine recurement?</h5>
    ...
    <div class="modal fade" id="ModalConfirmCenter">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <input type="hidden" name="" id="hiddenInput">
                    <h5 class="modal-title">Are you send this magazine to magazine recurement?</h5>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p>Number of magazine Selected : </p>
...
<style>
    a.badge.bg-primary.openModal:hover {
    color: white;
    }
    table {
