                                            ...
                                            <div class="email-left-box dz-scroll" id="email-left">
                                                ...
                                                <div class="mail-list rounded ">
                                                    <a class="list-group-item "
                                                        href="/periodical_publisher/publisher_notification">
                                                        <i
                                                            class="fa-regular fa-paper-plane align-middle"></i>Notification
                                                        List</a>

                                                    <a href="#" class="list-group-item active"><i
                                                            class="fa-regular fa-envelope align-middle"></i>Notification
                                                        View
                                                    </a>
                                                            ...
                                                            <div class="read-content">
                                                                <div
                                                                    ...
                                                                    <div class="clearfix mb-3 d-flex">
                                                                        <img class="me-3 rounded" width="70"
                                                                            height="70" alt="image"
                                                                            src="/../admin/images/default.png">
                                                                        <div class="media-body me-2">
                                                                            <h5 class="text-primary mb-0 mt-1">Ingredia
                                                                                Nutrisha</h5>
                                                                ...
                                                                <div class="media mb-2 mt-3">
                                                                    <div class="media-body"><span class="pull-end">07:23
                                                                            AM</span>
                                                                        <h5 class="my-1 text-primary">A collection of
                                                                            textile samples lay spread</h5>
                                                                        <p class="read-content-email">
                                                                            To: Me, info@example.com</p>
                                                                        <b>Hi,Ingredia,</b>
                                                                        <p>
                                                                            Ingredia Nutrisha, A collection of textile
                                                                            samples lay spread out on the table - Samsa
                                                                            was a travelling salesman - and above it
                                                                            ...
                                                                            World of Grammar. Aenean vulputate eleifend
                                                                        ...
                                                                        <div class="read-content-attachment">
                                                                            <div class="read-content-attachment">
                                                                                <div class="row attachment">
                                                                                     ...
                                                                                     <div class="col-auto">
                                                                                 <a href="#" class="text-muted"> attachment file</a>
                                                                                 </div>
