                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>Procurement Send Sample Magazine List</b>
                            </h3>
                            <a class="btn btn-primary  btn-sm" href=" {{ url('periodical_publisher/procurement') }}">
                                <i class="fa fa-angle-double-left" aria-hidden="true"></i> Apply For Procurement </a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            <tr role="row" class="odd">
                                                ...
                                                <td data-label="Status">
                                                    <a href="#" class="badge text-white bg-primary openModal"
