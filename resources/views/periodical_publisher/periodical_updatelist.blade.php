                                 ...
                                 <td>{{$loop->index+1}}></td>
                                    <td>
                                       <div >
                                             ...
                                             <h6><a class="text-left" href="/periodical_publisher/magazine_view/{{$val->id}}">{{$val->title}}</a></h6>
...
<script>
    $(document).ready(function () {
        ...
        $('#confirmDeleteBtn').on('click', function () {
            ...
            $.ajax({
                url: '/periodical_publisher/periodicalupdatedandreturn',
                method: 'POST',
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        $('#basicModal').modal('hide');
                        setTimeout(function () {
                            window.location.href = "/periodical_publisher/periodical_updatelist"
                        }, 3000);
                    } else {
