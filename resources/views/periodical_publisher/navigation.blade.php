	...
	<style>
        ...
        <div class="nav-header">
            <a href="/periodical/index" class="brand-logo">
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
						<div class="header-left">
                            <h4 class="ms-5"><b>{{auth('periodical_publisher')->user()->publicationName}}</b></h4>
						</div>
									...
									<div class="dropdown header-profile2">
										<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
											<div class="header-info2 d-flex align-items-center">
												...
												@if(auth('periodical_publisher')->user()->profileImage == Null)
                                                        <img  src="{{asset("images/default.png")}}"  alt="">

                                                        @else
                                                        <img id="navprofileImage" src="{{asset("periodical_publisher/images/profile/".auth('publisher')->user()->profileImage)}}"  alt="">
										...
										<div class="dropdown-menu dropdown-menu-end">
											<div class="card border-0 mb-0">
												<div class="card-header py-2">
													<div class="products">
													  @if(auth('periodical_publisher')->user()->profileImage == Null)
                                                        ...
                                                        @else
                                                        <img  src="{{asset("periodical_publisher/images/profile/".auth('periodical_publisher')->user()->profileImage)}}" class="avatar avatar-md" alt="">

                                                        @endif
														<div>
															<h6>{{auth('periodical_publisher')->user()->firstName}}   {{auth('periodical_publisher')->user()->lastName }}</h6>
															<span>{{auth('periodical_publisher')->user()->email }}</span>
														</div>
													</div>
												</div>
												<div class="card-body px-0 py-2">
													 <a href="/periodical_publisher/publisher_profile_view" class="dropdown-item ai-icon ">
													...
													<a href="/periodical_publisher/change_password" class="dropdown-item ai-icon ">
														<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
													 ...
													 <a href="/periodical_publisher/publisher_notification" class="dropdown-item ai-icon ">
														<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
												...
												<div class="card-footer px-0 py-2">
													<a href="/periodical/logout" class="dropdown-item ai-icon">
		...
		<div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a href="/periodical_publisher/index" class="" aria-expanded="false">
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="/periodical_publisher/procurement_samplemagazine">Procurement Sample Magazine Copies send list</a></li>
							<li><a href="/periodical_publisher/procurement_samplemagazinepending">Procurement Sample Magazine Copies pending list</a></li>
							<li><a href="/periodical_publisher/procurement_samplemagazinecomplete">Procurement Sample Magazine Copies Complete list</a></li>
                        </ul>
                    </li>
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/periodical_publisher/procurement_payment_list"> Payment Receipt List</a></li>
					...
					<i class="bi bi-chat-dots"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/periodical_publisher/feedback_add">Create Feedback</a></li>
