										...
										<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
											<div class="header-info2 d-flex align-items-center">
												...
												@if(auth('periodical_publisher')->user()->profileImage == Null)
                                                        ...
                                                        @else
                                                        <img id="navprofileImage" src="{{asset("periodical_publisher/images/profile/".auth('periodical_publisher')->user()->profileImage)}}"  alt="">
											...
											<div class="card border-0 mb-0">
												...
												<div class="card-body px-0 py-2">
													...
													<a href="/periodical_publisher/change_password" class="dropdown-item ai-icon ">
													 ...
													 <a href="/periodical_publisher/notification" class="dropdown-item ai-icon ">
														<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
$(document).ready(function() {
        ...
        $.ajax({
            url: '/periodical_publisher/notifications',
            type: 'GET',
       ...
       $(document).on('click','.notify',function(e){
        ...
        e.preventDefault();
          ...
          $.ajax({
             ...
             url: "/periodical_publisher/notificationstatus",
             success: function(response) {
                console.log(response);
...
$(document).ready(function() {
    $(".all-notification").click(function() {
        window.location.href = "/periodical_publisher/notification"; 
    });
});
