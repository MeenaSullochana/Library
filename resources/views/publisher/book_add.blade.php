                                                            ...
                                                            <tbody id="inputContainer">
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="isbn_number1[]"
                                                                            placeholder="Enter the Total Number Volume"
                                                                            class="form-control" ></td>
                                ...
                                <div class="col-lg-12">
                                     <div class="basic-form">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control" id="subjects1" name="subject" required>
                                                        <option value="">Select One</option>
    ...
    <div class="mb-3">
        ...
        <div class="input-group">
            ...
            <input type="number" class="form-control" id="discountedprice1"
                name="discountedprice1" placeholder="Enter the Discounted Price.." hidden>
                                ...
                                <div class="col-lg-12">
                                    <div class="basic-form">
                                        ...
                                        <div class="row">
                                            ...
                                            <textarea name="author_description" id="author_description" required></textarea>
