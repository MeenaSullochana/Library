...
$(document).ready(function() {
    $('#sendcopies').on('click', function() {
        ...
        // }).get();
        // var checkebookTitles = $('#customCheckBox100:checked').map(function() {
        //     return $(this).data('book-title');
        // }).get();
        // alert(checkebookTitles);
        // $('#hiddenId').val(checkebook);
        // $('#hiddentitle').val(checkebook);
...
$(document).ready(function() {
    ...
    var checkebook = $('#customCheckBox100:checked').map(function() {
        ...
        var bookJsonString = JSON.stringify(checkebook);
            ...
            $.ajax({
                type: "post",
                url: "/publisher/procurementbokkcopies-send",
                data: formData,
                processData: false,
                contentType: false,
                success: function(response) {
