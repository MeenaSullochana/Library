		...
		<div class="container-fluid">
			<div class="row p-3 bg-white rounded-2 mb-3">
                  <div class="col-md-12 d-flex justify-content-between">
                     ...
                     <div class="item">
                       <a href="/publisher/index"> <button type="button" class="btn btn-primary"><i class="fa fa-backward" aria-hidden="true"></i> Back</button></a>
                     </div>
                  </div>
               </div>
				<div class="row">
                                            ...
                                            <div class="tab-content" id="pills-tabContent">
                                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                                    <div class="email-list dz-scroll" id="emails">
                                                        @php
                                                            $notifications = DB::table('notifications')->where('to','=',auth('publisher')->user()->id)->paginate(10);
                                                        @endphp
                                                        ...
                                                        @forelse($notifications as $notification)
                                                            <div class="message">
                                                                <div>
                                                                    ...
                                                                    <a href="/publisher/Notification_virw/{{$notification->id}}" class="col-mail col-mail-2">
