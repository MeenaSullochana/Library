...
<html lang="en" class="h-100">
   <head>
      ...
      <!-- PAGE TITLE HERE -->
      <title>Government of Tamil Nadu - Book Procurement - Publisher - Login </title>
      <!-- FAVICONS ICON -->
                           ...
                           <div class="login-form style-2">
                              <div class="card-body">
                                 <div class="logo-header">
                                    <a href="index.php" class="logo"><img src="images/logo.png" alt="" width="100%" class=" light-logo"></a>
                                    <a href="index.php" class="logo"><img src="images/logo.png" alt="" width="100%" class=" dark-logo"></a>
                                 </div>
                                 <nav>
                                          ...
                                          <div class="tab-pane fade show active" id="nav-personal" role="tabpanel" aria-labelledby="nav-personal-tab">
                                             <form  class=" dz-form pb-3" method="POST">
                                                ...
                                                <div class="form-group mb-3">
                                                   <input type="text" class="form-control" placeholder="info@gmail.com" name="username">
                                                </div>
                                                <div class="form-group mb-3">
                                                   <input type="password" class="form-control"  placeholder="password" name="password">
                                                </div>
                                                <div class="form-group text-left mb-5 forget-main">
                                                   <button type="submit" class="btn btn-primary" name="login">Sign Me In</button>
                                             ...
                                             <div class="text-center bottom">
                                              <a href="../register.php"></a>  <button class="btn btn-primary button-md btn-block" id="nav-sign-tab" data-bs-toggle="tab" data-bs-target="" type="button" role="tab" aria-controls="nav-sign" aria-selected="false">Create an account</button>
                                             </div>
                                          </div>
                              ...
                              <div class="card-footer">
                                 <div class=" bottom-footer clearfix m-t10 m-b20 row text-center">
                                    <div class="col-lg-12 text-center">
                                       <span> Copyright © 2023 Directorate of Public Libraries, பொது நூலக இயக்ககம். All rights reserved by Direcorate of Public Libraries. </span>
                                    </div>
                                 </div>
                              </div>
                           </div>
