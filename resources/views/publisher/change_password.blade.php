                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="mb-3 row">
                                                ...
                                                {{-- <div class="col-lg-6">
                                                    <input type="password" class="form-control" id="cudz-passwordrrentPassword"
                                                        placeholder="Enter Current Password" required="" value="">
                                                        <span class="input-group-text show-pass br-style active">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-group transparent-append">
                                                        ...
                                                        <input type="text" class="form-control" id="dz-password" placeholder="Enter Current Password" required="">
                                                        <span class="input-group-text show-pass br-style active">
                                                            <i class="fa fa-eye-slash"></i>
                                                            <i class="fa fa-eye"></i>
                                                        </span>
