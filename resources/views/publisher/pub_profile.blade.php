                                    ...
                                    <div class="card-body">
                                        <div class="profile-interest">
                                            <div class="row mt-4 sp4" id="lightgallery">
                                                ...
                                                <a href="{{asset("public/publisher/images/proof/BookCatalogue/".$data->bookCatalogue)}}" data-exthumbimage="{{asset("public/publisher/images/proof/BookCatalogue/".$data->bookCatalogue)}}"
                                                    data-src="{{asset("public/publisher/images/proof/BookCatalogue/".$data->bookCatalogue)}}"
                                                    class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6" download>
                                                    <h3  class="btn btn-primary light btn-xs mb-1">  Book Catalogue </h3>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row mt-4 sp4" id="lightgallery">
                                                ...
                                                @endif
                                                 @if($data->panOrTanProof != null)
                                                      <a href="{{asset("public/publisher/images/proof/pan_tan/".$data->panOrTanProof)}}" data-exthumbimage="{{asset("public/publisher/images/proof/pan_tan/".$data->panOrTanProof)}}"
                                                    data-src="{{asset("public/publisher/images/proof/pan_tan/".$data->panOrTanProof)}}"
                                                    class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6" download>
                                                    <h3  class="btn btn-primary light btn-xs mb-1">  PAN / TAN  </h3>
                                                </a>
                                                @endif
                                                 @if($data->udyamProof != null)
                                                    <a href="{{asset("public/publisher/images/proof/udayam/".$data->udyamProof)}}" data-exthumbimage="{{asset("public/publisher/images/proof/udayam/".$data->udyamProof)}}"
                                                    data-src="{{asset("public/publisher/images/proof/udayam/".$data->udyamProof)}}"
                                                    class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6" download>
                                                    <h3  class="btn btn-primary light btn-xs mb-1"> Udyam Certificate </h3>
                                                </a>
                                                @endif
                                                @if($data->certificationIncorporationProof != null)
                                                      <a href="{{asset("public/publisher/images/proof/certification_incon/".$data->certificationIncorporationProof)}}" data-exthumbimage="{{asset("public/publisher/images/proof/certification_incon/".$data->certificationIncorporationProof)}}"
                                                    data-src="{{asset("public/publisher/images/proof/certification_incon/".$data->certificationIncorporationProof)}}"
                                                    class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6" download>
                                                    <h3  class="btn btn-primary light btn-xs mb-1"> Certificate of Incorporation </h3>
                                                </a>
                                                @endif
                                                @if($data->certificationRegistrationProof != null)
                                                      <a href="{{asset("public/publisher/images/proof/cgReg/".$data->certificationRegistrationProof)}}" data-exthumbimage="{{asset("public/publisher/images/proof/cgReg/".$data->certificationRegistrationProof)}}"
                                                    data-src="{{asset("public/publisher/images/proof/cgReg/".$data->certificationRegistrationProof)}}"
                                                    class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6" download>
                                                    <h3  class="btn btn-primary light btn-xs mb-1">  Certificate of Registration </h3>
                                                </a>
                                                @endif
                                                @if($data->partnershipDeedProof != null)
                                                       <a href="{{asset("public/publisher/images/proof/pan_deed/".$data->partnershipDeedProof)}}" data-exthumbimage="{{asset("public/publisher/images/proof/pan_deed/".$data->partnershipDeedProof)}}"
                                                    data-src="{{asset("public/publisher/images/proof/pan_deed/".$data->partnershipDeedProof)}}"
                                                    class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6" download>
                                                ...
                                                @endif
                                                  @if($data->llpProof != null)
                                                        <a href="{{asset("public/publisher/images/proof/llp_agre/".$data->llpProof)}}" data-exthumbimage="{{asset("public/publisher/images/proof/llp_agre/".$data->llpProof)}}"
                                                    data-src="{{asset("public/publisher/images/proof/llp_agre/".$data->llpProof)}}"
                                                    class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6" download>
                                                    <h3  class="btn btn-primary light btn-xs mb-1">  LLP Agreement </h3>
                                                </a>
                                                @endif
                                                    @if($data->aoaProof != null)
                                                        <a href="{{asset("public/publisher/images/proof/aoa/".$data->aoaProof)}}" data-exthumbimage="{{asset("public/publisher/images/proof/aoa/".$data->aoaProof)}}"
                                                    data-src="{{asset("public/publisher/images/proof/aoa/".$data->aoaProof)}}"
                                                    class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6" download>
                                ...
                                <table id="example1" class="display table" style="min-width: 845px">
                                    ...
                                    @foreach($data->subsidiary1 as $val)
                                        <tr>
                                            ...
                                            <td>
                                            <a href="{{asset("public/publisher/images/proof/sub_doc/".$val->subsidiary_doc)}}" data-exthumbimage="{{asset("public/publisher/images/proof/sub_doc/".$val->subsidiary_doc)}}"
                                                    data-src="{{asset("public/publisher/images/proof/sub_doc/".$val->subsidiary_doc)}}"
                                                    class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6" download="true">
