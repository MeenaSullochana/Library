                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="pub_details">
                                ...
                                <div class="row mb-3 border border-0 p-2 m-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="invalid-feedback"> Please enter the distribution name</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="authorization_latter">
                                <p class="fw-bold">The periodical added in "Periodicals in your distribution" with authorization from the respective publisher in the registration part are the only ones to be added for procurement  - <span class="mt-055">உங்கள் விநியோகத்தில்
