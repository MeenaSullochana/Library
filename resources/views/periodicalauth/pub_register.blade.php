                        ...
                        <div class="row">
                           ...
                           required />
                                ...
                                <div class="row mb-3 border border-0 p-2 m-2">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control " id="inputEmail4"
                                            name="magazine_publication_name" placeholder="Enter the Periodical/Magazine Publication Details" required>
                                ...
                                <div class="row mb-3 border border-0 p-2 m-2">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="pub_first_name"
                                            placeholder="First name" name="pub_first_name" required>
                                        <div class="valid-feedback"> Looks good! </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="pub_last_name"
                                            placeholder="Last name" required name="pub_last_name">
                                        <div class="valid-feedback"> Looks good!</div>
                               ...
                               @endforeach
                                 ...
                                 placeholder="Enter your city" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        name="pub_pin_code" placeholder="Pin code" required>
                                        <div class="valid-feedback"> Looks good!</div>
                                        <div class="invalid-feedback"> Please Enter Last Name. </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label for="validationTextarea" class="form-label">Publication Address<span
                                                class="text-danger maditory">*</span></label>
                                        <textarea class="form-control" name="pub_address" id="pub_address" placeholder="Publication Address" required></textarea>
                                        <div class="valid-feedback"> Looks good!</div>
                                ...
                                <div class="row mb-3 border border-0 p-2 m-2">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="con_first_name"
                                            placeholder="First name" name="contact_first_name" required>
                                        <div class="valid-feedback"> Looks good! </div>
                                        <div class="invalid-feedback"> Please Enter First Name. </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                ...
                                @foreach ($district as $val)
                                 ...
                                 placeholder="Enter your city" required>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="validationTextarea" class="form-label">Publication Address<span
                                                class="text-danger maditory">*</span></label>
                                        <textarea class="form-control" name="con_publication_address" id="con_publication_address" placeholder="Required Address" required></textarea>
                                        <div class="valid-feedback"> Looks good!</div>
                            ...
                            <div class="other_details">
                                ...
                                <div class="row mb-3 border border-0 p-2 m-2">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        name="publication_shop_established_year" placeholder="Year of Establishment" required>
                                        <div class="valid-feedback"> Looks good! </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        name="year_of_experience" placeholder="years of experience in Periodical/magazine publication"
                                            required>
                                        <div class="valid-feedback"> Looks good!</div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="validationCustom02" class="form-label">Number of
                                            ...
                                            இதழ்களின் எண்ணிக்கை ( பொது நூலகங்கள் அல்லாது)<span
                                                class="text-danger maditory">*</span></label>
                                        <input type="number" class="form-control" id="validationCustom02"
                                        name="number_of_magazines_year"  placeholder="Number of periodical/magazine circulation per year" required>
                                        <div class="valid-feedback"> Looks good!</div>
                                                ...
                                                <div class="subsidiary_pub_name_bg_oldmy" name="member_in_publishers_old_asrmy"
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered" id="trans_book_pub_dis_asrmy">
                                                            ...
                                                            <tr>
                                                                <td><input type="text" name="trs_state_awarded[]" id="pub_test"
                                                                        placeholder="Enter the award name*"
                                                                        class="form-control name_list" /></td>
                                                                <td><input type="text" name="trs_central_awarded[]" id="pub_testone"
