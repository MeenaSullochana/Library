...
<body>
    ...
    <main>
        ...
        <div class="breadcrumb__area pt-5 pb-5">
         ...
         <!-- checkout-area start -->
         <section class="checkout-area pb-50 mt-5">
            <div class="container">
               <form action="#">
                  <div class="row">
                              ...
                              <div class="row">
                                    ...
                                    <div class="col-md-12">
                                       <div class="checkout-form-list">
                                          ...
                                          <textarea type="text" placeholder="Street address" rows="10" class="form-control"></textarea>
                                       </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                       <div class="checkout-form-list">
                                          <label>Town / City / Village <span class="required">*</span></label>
                                          <input type="text" placeholder="Town / City / Village" >
                                       </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-12">
                           <div class="different-address">
                              ...
                              <div class="order-notes">
                                 <div class="checkout-form-list">
                                    <label>Approved by Reader Forum</label>
