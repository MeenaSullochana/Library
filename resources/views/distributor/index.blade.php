...
<head>
    ...
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('distributor/images/favicon.png') }}">
...
<!-- Style css -->
<link href="{{asset('distributor/css/style.css')}}" rel="stylesheet">
...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="black"
                        ...
                        <div class="card overflow-hidden">
                            <div class="card-body">
                                <div class="any-card">
                                    <div class="c-con">
                                               @php
                                        $name = auth('distributor')->user()->firstName." ".auth('distributor')->user()->lastName;
                                    @endphp
                                ...
                                <div class="col-xl-6 col-sm-6 col-12">
                                    ...
                                    <div class="card ov-card">
                                        <div class="card-body">
                                            ...
                                            <div class="col-xl-6 col-sm-6 col-12">
                                            <a href="/distributor/nego_approved_list" style="text-decoration: none; color: inherit;">
                                            ...
                                            <div class="col-xl-6 col-sm-6 col-12">
                                            <a href="/distributor/nego_pending_list" style="text-decoration: none; color: inherit;">
                                            ...
                                            <div class="col-xl-6 col-sm-6 col-12">
                                              <a href="/distributor/price_nego_list" style="text-decoration: none; color: inherit;">
                                            ...
                                            <div class="col-xl-6 col-sm-6 col-12">
                                               <a href="/distributor/nego_failed_list" style="text-decoration: none; color: inherit;">
                                            ...
                                            <div class="col-xl-6 col-sm-6 col-12">
                                            <a href="/distributor/nego_process_list"
                                        ...
                                        <div class="col-xl-6 col-sm-6 col-12">
                                            <a href="/distributor/nego_reprocess_list"
                                                style="text-decoration: none; color: inherit;">
    ...
    ***********************************-->
    ...
    <!-- Dashboard 1 -->
    <script src="{{asset('distributor/js/dashboard/dashboard-1.js')}}"></script>
    ...
    <script src="{{asset('distributor/js/plugins-init/datatables.init.js')}}"></script>
    ...
    <script src="{{asset('distributor/js/custom.js')}}"></script>
    <script src="{{asset('distributor/js/deznav-init.js')}}"></script>
