                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>Renegotiation By Admin Book List</b>
                            </h3>
                                    ...
                                    <table id="example3" class="table dataTable no-footer" role="grid" aria-describedby="empoloyees-tbl3_info">
                                        <thead>
                                            ...
                                            <th>S.No</th>
                                                ...
                                                <th>Renegotiation Vendor Price</th>
                                                <th>Renegotiation Vendor Reason</th>
                                                <th>Renegotiation Admin Price</th>
                                                <th>Renegotiation Admin Reason</th>
                                            ...
                                            <td data-label="S.No"><span>{{$loop->index +1}}</span></td>
                                                ...
                                                <td data-label="Negotiation Price">
                                                  ...
                                                  <td data-label="Negotiation Price">
                                                    ...
                                                    <span><a href="#" >Rs {{$val->renegotiation_price}}</a> </span>
                                                    @else
                                                    <span>N/A</span>
                                                    @endif
                                                </td>
                                                     ...
                                                     <td data-label="Negotiation Message">
                                                   <button type="button" id="successButton11122" class="btn btn-primary btn-sm" data-id="{{$val->renegotiation_message}}">View</button>
                                                  </td>
...
<div class="modal fade" id="myModal122" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Renegotiation Admin Reason</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body" id="modalBodyContent122"></div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger light" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        $('#example3').on('click', '#successButton11122', function() {
            var message = $(this).data('id');
            console.log(message);
            $('#modalBodyContent122').html(message);
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        setTimeout(function() {
                            window.location.href = "/distributor/nego_reprocess_list";
                        }, 3000);
