                                ...
                                <div class="col-md-2">
                                    <div class="d-sm-flex align-items-center justify-content-between">
                                        <button class="btn btn-info assignPro justify-content-between"
                                            data-bs-toggle="modal" data-bs-target="#basicModal">Assign</button>
...
<script>
    $('.submitbutton11').click(function() {
        ...
        $.ajax({
            url: '/distributor/applay_procurment',
            method: 'POST',
            data: requestData,
            success: function(response) {
                ...
                if (response.success) {
                    setTimeout(function() {
                        window.location.href = "/distributor/payment";
                    }, 3000);
