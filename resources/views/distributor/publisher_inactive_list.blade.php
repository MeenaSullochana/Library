<?php
    @ob_start();
   include "core/publisher_list.core.php";
            ...
            <div class="container-fluid">
               ...
               <div class="table-responsive">
                  <table id="example4" class="display table" style="min-width: 845px">
                     ...
                     <tbody>
                        <?php
                        if(!empty($inactivedistriputorList)){
                        foreach($inactivedistriputorList as $listPub){
                            ?>
                            <tr>
                                <td>01</td>
                                <td><?php echo $listPub['publication_name_or_distributor_name']?></td>
                                <td><?php echo $listPub['pub_contact_number']?></td>
                                <td><?php echo $listPub['pub_state']?></td>
                                <td>
                                <form method="POST">
                                    <div class="form-check form-switch">
                                          ...
                                          ?>"<?php if($listPub['status'] == 'Active'){
                                             echo "checked";
                                          }?> data-isprm="<?php echo $listPub['publisher_id']; ?>">
                                ...
                                <td><a href="pub_profile.php?userid=<?php echo $listPub['publisher_id'];?>"><i class="fa fa-eye p-2"></i></a>
      ...
      <?php
        ...
        $(document).ready(function() {
            $("input[type=checkbox]").change(function() {
                ...
                url: "core/ajex.php",
                type: "POST",
                data:  {pub_status: $(this).val(), id: $(this).attr("data-isprm")},
