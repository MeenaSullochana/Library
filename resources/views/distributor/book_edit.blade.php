                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a class="btn btn-primary  btn-sm" href=" {{ url('distributor/book_manage_all') }}">
                                <i class="fa fa-angle-double-left" aria-hidden="true"></i> List of Book </a>
                        </div>
                    </div>
                </div>
                <form class="row g-3 mt-2" method="POST" enctype="multipart/form-data" id ="ourFormId" action="/distributor/update/book"
                    autocomplete="on">
                    @csrf
                                     ...
                                     <div class="basic-form">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class=" wide form-control" id="subjects1"
                                                        name="subject" required>

                                                        @php
                                                          $categori = DB::table('book_subject')->where('type','=',$data->language)->where('status','=','1')->get();
                                                          @endphp
                                                          @foreach($categori as $val)
    ...
    <div class="mb-3">
        ...
        <div class="input-group">
            ...
            <input type="number" class="form-control" id="discountedprice"
                name="discountedprice" placeholder="Enter Discounted Price.." value="{{$data->discountedprice}}" disabled>
            <div class="invalid-feedback">
                Book Title cannot be edited agter your book has been
                published.
                Click here to learn more.
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="file" id="files" name="banner_img[]" multiple required />
...
$('.highlights_delete').on('click', function() {
    ...
    $.ajax({
        url: "/distributor/remove-image-highlights",
        type: "POST",
        dataType: "json",
        data: {
            _token: "{{ csrf_token() }}",
...
@elseif (Session::has('error'))
    ...
    <script>
                toastr.error("{{ Session::get('imageerror') }}", {
            timeout: 15000,
...
$("input[name='language']").change(function () {
   ...
   $.ajax({
      type: "post",
      dataType: "json",
      url: '/distributor/getlanguage',
      data: {'lang':lang},
       success: function(response) {
           var subjects22 = response.subjects;
           $('#subjects1').empty();
           $('#subjects1').append('<option value="">Select One</option>');
