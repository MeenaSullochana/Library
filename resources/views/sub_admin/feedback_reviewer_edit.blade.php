                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>View Reviewer Feedback</b>
                            </h3>
                            <a class="btn btn-primary  btn-sm" href="/sub_admin/feedback_publisher_distributor_list">
                ...
                <div class="row">
                    <div class="col-lg-12 card-profile">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card ">
                                    <div class="sub_admin-user">
                                        <h4 class="">Profile Details</h4>
                                        <div class="img-wrraper">
                                            <div class="">
                                                @if($data->image != null)
                                                <img src="{{ asset("reviewer/ProfileImage/".$data->image) }}" class="rounded-circle">
                                                @else
