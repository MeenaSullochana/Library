...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Government of Tamil Nadu - Book Procurement - List of Publisher Feedback</title>
    <!-- FAVICONS ICON -->
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>List of Publisher Feedback</b>
                            </h3>
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example4" rowspan="1"
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="example4" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Mobilenumber: activate to sort column ascending"
                                        ...
                                        @foreach($data as $val)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                        ...
                                                        @if($val->image != null)
                                                                <img src="{{ asset("publisher/images/profile/".$val->image) }}" class="rounded-lg me-2" width="24" alt="">
                                                            @else
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                    <a href="/sub_admin/feedback_publisher/{{$val->id}}"
