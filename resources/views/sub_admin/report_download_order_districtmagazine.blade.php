                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>Magazine District Order Report Download</b>
                            </h3>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Magazine District Order Report Download</h4>

                            </div>
                            <div class="card-body">
                                <form class="needs-validation" novalidate method="POST"
                                    action="/sub_admin/magazine_district_order" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-4 mb-3">
                                            <label class="form-label">Magazine Title <span
                                                    class="text-danger mandatory"></span></label>
                                            <select class="form-select bg-white" name="title" id="title">
                                            @php
