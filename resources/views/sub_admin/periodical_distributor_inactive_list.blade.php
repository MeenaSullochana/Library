    ...
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title">
                                <b>Periodical Distributor Inactive List</b>
                            </h3>
                ...
                @php
                $publisher = DB::table('periodical_distributors')->where('status','0')->get();
                @endphp
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                          ...
                          <td style="white-space:normal;"> <span class="badge bg-success text-white">Approve</span></td>
                           ...
                           @endif -->
                                        ...
                                        <td>
                                            <a href="/sub_admin/periodical_distributor_view/{{$val->id}}"><i class="fa fa-eye p-2"></i></a>
