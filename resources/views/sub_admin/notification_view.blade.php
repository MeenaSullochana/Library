                                    ...
                                    <div class="col-xl-2 col-xxl-3">
                                        <div class="email-left-body">
                                            <div class="email-left-box dz-scroll" id="email-left">
                                                ...
                                                <a class="list-group-item " href="/sub_admin/notification">
                                                    ...
                                                    <div class="right-box-padding p-0">
                                                        <div class="read-wapper dz-scroll" id="read-content">
                                                            <div class="read-content">
                                                                <div
                                                                    class="media pt-3 d-flex d-block justify-content-between">
                                                                    <div class="clearfix mb-3 d-flex">
                                                                    @if($data->profileImage == null)
                                                                      <img class="me-3 rounded" width="70" height="70" alt="image" src="{{ asset("sub_admin/images/default.png") }}">
                                                                      @elseif($data->type == 'publisher')
                                                                      <img class="me-3 rounded" width="70" height="70" alt="image" src="{{ asset("publisher/images/profile/".$data->profileImage) }}">
                                                                       @elseif($data->type == 'distributor')
                                                                     <img class="me-3 rounded" width="70" height="70" alt="image" src="{{ asset("distributor/images/profile/".$data->profileImage) }}">
                                                                        @else
                                                                        <img class="me-3 rounded" width="70" height="70" alt="image" src="{{ asset("publisher_and_distributor/images/profile/".$data->profileImage) }}">
                                                                           @endif
